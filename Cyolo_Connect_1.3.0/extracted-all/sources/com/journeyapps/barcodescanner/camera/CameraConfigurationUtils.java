...
public final class CameraConfigurationUtils {
    ...
    public static void setFocus(Camera.Parameters parameters, CameraSettings.FocusMode focusMode, boolean z) {
        ...
        if (z || focusMode == CameraSettings.FocusMode.AUTO) {
            strFindSettableValue = findSettableValue("focus mode", supportedFocusModes, DebugKt.DEBUG_PROPERTY_VALUE_AUTO);
        } else if (focusMode == CameraSettings.FocusMode.CONTINUOUS) {
            strFindSettableValue = findSettableValue("focus mode", supportedFocusModes, "continuous-picture", "continuous-video", DebugKt.DEBUG_PROPERTY_VALUE_AUTO);
