...
final class ProtobufDataEncoderContext implements ObjectEncoderContext {
    ...
    private static final FieldDescriptor MAP_VALUE_DESC = FieldDescriptor.builder(MainActivityKt.INTENT_SERVICE_STATUS_EXTRA_VALUE).withProperty(AtProtobuf.builder().tag(2).build()).build();
