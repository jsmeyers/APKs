        ...
        final void encodeUtf8Default(CharSequence in, ByteBuffer out) {
            ...
            while (i < length) {
                ...
                if (cCharAt2 < 128) {
                    ...
                    int i2 = iPosition + 1;
                    try {
                        out.put(iPosition, (byte) ((cCharAt2 >>> 6) | Wbxml.EXT_0));
            ...
            while (i2 < length2) {
                ...
                if (cCharAt2 >= c || j4 >= j5) {
                    if (cCharAt2 < 2048 && j4 <= j5 - 2) {
                            ...
                            if (j4 <= j5 - 4) {
                                ...
                                if (i3 != length2) {
                                    ...
                                    if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                        ...
                                        long j8 = j7 + 1;
                                        UnsafeUtil.putByte(out, j7, (byte) (((codePoint >>> 12) & 63) | 128));
                                        long j9 = j8 + 1;
                                        UnsafeUtil.putByte(out, j8, (byte) (((codePoint >>> 6) & 63) | 128));
                                        j3 = 1;
                                        j2 = j9 + 1;
                                        UnsafeUtil.putByte(out, j9, (byte) ((codePoint & 63) | 128));
                                        i2 = i3;
                                    } else {
                                        i2 = i3;
                                    }
                        ...
                        long j11 = j10 + j;
                        UnsafeUtil.putByte(out, j10, (byte) (((cCharAt2 >>> 6) & 63) | 128));
                        UnsafeUtil.putByte(out, j11, (byte) ((cCharAt2 & '?') | 128));
                        j2 = j11 + 1;
                        j3 = 1;
                    }
                    i2++;
