...
public class CountryCodeToRegionCodeMap {
    public static Map<Integer, List<String>> getCountryCodeToRegionCodeMap() {
        ...
        arrayList75.add("CD");
        map.put(Integer.valueOf(WKSRecord.Service.SUR_MEAS), arrayList75);
        ArrayList arrayList76 = new ArrayList(1);
        arrayList76.add("AO");
        map.put(244, arrayList76);
        ArrayList arrayList77 = new ArrayList(1);
        arrayList77.add("GW");
        map.put(Integer.valueOf(WKSRecord.Service.LINK), arrayList77);
        ...
        arrayList90.add("MZ");
        map.put(Integer.valueOf(Type.AVC), arrayList90);
        ArrayList arrayList91 = new ArrayList(1);
        arrayList91.add("ZM");
        map.put(Integer.valueOf(Type.AMTRELAY), arrayList91);
        ...
        arrayList134.add("SK");
        map.put(Integer.valueOf(StatusLine.HTTP_MISDIRECTED_REQUEST), arrayList134);
