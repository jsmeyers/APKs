...
public final class GsonBuilder {
    ...
    public GsonBuilder addReflectionAccessFilter(ReflectionAccessFilter reflectionAccessFilter) {
        ...
        List.EL.addFirst(this.reflectionFilters, reflectionAccessFilter);
        return this;
    }

    public Gson create() {
        java.util.List<TypeAdapterFactory> arrayList = new ArrayList<>(this.factories.size() + this.hierarchyFactories.size() + 3);
    ...
    private void addTypeAdaptersForDate(String str, int i, int i2, java.util.List<TypeAdapterFactory> list) {
