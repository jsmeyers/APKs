...
final class DecodedBitStreamParser {
    ...
    private static final byte[] COUNTRY_BYTES = {53, 54, 43, JsonWriter.COMMA, 45, 46, 47, 48, 37, 38};
    private static final byte[] SERVICE_CLASS_BYTES = {55, 56, 57, JsonWriter.SEMI, 59, 60, 49, 50, 51, 52};
    private static final byte[] POSTCODE_2_LENGTH_BYTES = {39, 40, 41, 42, Ascii.US, 32};
    private static final byte[] POSTCODE_2_BYTES = {33, JsonWriter.QUOTE, 35, 36, Ascii.EM, Ascii.SUB, Ascii.ESC, Ascii.FS, Ascii.GS, Ascii.RS, 19, Ascii.DC4, Ascii.NAK, Ascii.SYN, Ascii.ETB, Ascii.CAN, Ascii.CR, Ascii.SO, Ascii.SI, Ascii.DLE, 17, Ascii.DC2, 7, 8, 9, 10, 11, Ascii.FF, 1, 2};
    private static final byte[][] POSTCODE_3_BYTES = {new byte[]{39, 40, 41, 42, Ascii.US, 32}, new byte[]{33, JsonWriter.QUOTE, 35, 36, Ascii.EM, Ascii.SUB}, new byte[]{Ascii.ESC, Ascii.FS, Ascii.GS, Ascii.RS, 19, Ascii.DC4}, new byte[]{Ascii.NAK, Ascii.SYN, Ascii.ETB, Ascii.CAN, Ascii.CR, Ascii.SO}, new byte[]{Ascii.SI, Ascii.DLE, 17, Ascii.DC2, 7, 8}, new byte[]{9, 10, 11, Ascii.FF, 1, 2}};
