        ...
        if (i2 != 0) {
            ...
            while (true) {
                ...
                if (size2 <= i12) {
                    ...
                    int i14 = i12 - (i12 % i10);
                    if ((!z2 || bitArrayStuffBits2.getSize() <= i10 * 64) && bitArrayStuffBits2.getSize() + size <= i14) {
        ...
        while (i21 < iAbs) {
            ...
            while (i24 < i23) {
                ...
                while (i6 < i16) {
                    ...
                    if (bitArrayGenerateCheckWords.get((i23 * 4) + i22 + i25 + i6)) {
                        int i28 = (i15 - 1) - (i21 * 2);
