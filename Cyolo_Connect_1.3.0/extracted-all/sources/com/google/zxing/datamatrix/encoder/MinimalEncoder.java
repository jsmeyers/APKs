...
public final class MinimalEncoder {
    static final char[] C40_SHIFT2_CHARS = {'!', Typography.quote, '#', Typography.dollar, '%', Typography.amp, '\'', '(', ')', '*', '+', ',', '-', FilenameUtils.EXTENSION_SEPARATOR, IOUtils.DIR_SEPARATOR_UNIX, ':', ';', Typography.less, '=', Typography.greater, '?', '@', '[', IOUtils.DIR_SEPARATOR_WINDOWS, ']', '^', '_'};
    ...
    private static final class Edge {
        ...
        /* JADX WARN: Found duplicated region for block: B:20:0x003c A[PHI: r9
        ...
        /* JADX WARN: Found duplicated region for block: B:21:0x0040 A[PHI: r9
        ...
        private Edge(Input input, Mode mode, int i, int i2, Edge edge) {
            ...
            switch (AnonymousClass1.$SwitchMap$com$google$zxing$datamatrix$encoder$MinimalEncoder$Mode[mode.ordinal()]) {
                case 1:
                    numberOfC40Words++;
                    numberOfC40Words = (input.isECI(i) || MinimalEncoder.isExtendedASCII(input.charAt(i), input.getFNC1Character())) ? numberOfC40Words + 1 : numberOfC40Words;
                ...
                case 2:
                    numberOfC40Words++;
                    numberOfC40Words = (previousMode != Mode.B256 || getB256Size() == 250) ? numberOfC40Words + 1 : numberOfC40Words;
    ...
    private static final class Result {
        ...
        Result(Edge edge) {
            ...
            int i2 = 0;
            int iPrepend = ((edge.mode == Mode.C40 || edge.mode == Mode.TEXT || edge.mode == Mode.X12) && edge.getEndMode() != Mode.ASCII) ? prepend(Edge.getBytes(254), arrayList) + 0 : 0;
                ...
                if (edge2.previous == null || edge2.getPreviousStartMode() != edge2.getMode()) {
                    if (edge2.getMode() == Mode.B256) {
                        if (iPrepend <= 249) {
                            ...
                            arrayList.add(0, Byte.valueOf((byte) ((iPrepend / 250) + Type.TKEY)));
                            i = iPrepend + 2;
                        }
