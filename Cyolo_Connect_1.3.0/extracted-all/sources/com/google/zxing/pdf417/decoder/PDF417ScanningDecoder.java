...
public final class PDF417ScanningDecoder {
        ...
        while (true) {
            ...
            if (!z || boundingBox2 == null || (boundingBox2.getMinY() >= boundingBox.getMinY() && boundingBox2.getMaxY() <= boundingBox.getMaxY())) {
                ...
                for (int i6 = 1; i6 <= barcodeColumnCount; i6++) {
                    int i7 = z2 ? i6 : barcodeColumnCount - i6;
                    if (detectionResultMerge.getDetectionResultColumn(i7) == null) {
                        ...
                        detectionResultMerge.setDetectionResultColumn(i7, detectionResultColumn2);
                        int i8 = -1;
                        int minY = boundingBox.getMinY();
                        int i9 = -1;
                        while (minY <= boundingBox.getMaxY()) {
                            int startColumn = getStartColumn(detectionResultMerge, i7, minY, z2);
                            ...
                            int i10 = minY;
                            detectionResultColumn = detectionResultColumn2;
                            Codeword codewordDetectCodeword = detectCodeword(bitMatrix, boundingBox.getMinX(), boundingBox.getMaxX(), z2, i3, i10, iMin, iMax);
                            i5 = i10;
                            if (codewordDetectCodeword != null) {
                                detectionResultColumn.setCodeword(i5, codewordDetectCodeword);
    ...
    /* JADX WARN: Found duplicated region for block: B:11:0x0013 A[DONT_INVERT] */
    /* JADX WARN: Found duplicated region for block: B:12:0x0015  */
    /* JADX WARN: Found duplicated region for block: B:28:0x0027 A[EDGE_INSN: B:28:0x0027->B:16:0x0027 BREAK  A[LOOP:0: B:7:0x000c->B:31:0x000c], SYNTHETIC] */
    /* JADX WARN: Found duplicated region for block: B:29:0x0022 A[SYNTHETIC] */
    /* JADX WARN: Found duplicated region for block: B:30:0x001b A[SYNTHETIC] */
    ...
    /* JADX WARN: Found duplicated region for block: B:12:0x0011  */
    /* JADX WARN: Found duplicated region for block: B:14:0x0017  */
    /* JADX WARN: Found duplicated region for block: B:17:0x0020 A[LOOP:1: B:8:0x000a->B:17:0x0020, LOOP_END] */
    /* JADX WARN: Found duplicated region for block: B:21:0x001f A[SYNTHETIC] */
    /* JADX WARN: Found duplicated region for block: B:24:0x0022 A[EDGE_INSN: B:24:0x0022->B:18:0x0022 BREAK  A[LOOP:1: B:8:0x000a->B:17:0x0020], SYNTHETIC] */
