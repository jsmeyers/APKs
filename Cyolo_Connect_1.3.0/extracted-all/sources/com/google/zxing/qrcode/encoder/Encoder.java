...
public final class Encoder {
    ...
    /* JADX WARN: Found duplicated region for block: B:61:0x0148  */
    public static QRCode encode(String str, ErrorCorrectionLevel errorCorrectionLevel, Map<EncodeHintType, ?> map) throws WriterException {
        ...
        Charset charsetForName = z3 ? Charset.forName(map.get(EncodeHintType.CHARACTER_SET).toString()) : obj;
        if (z2) {
            mode = Mode.BYTE;
    ...
    static void appendKanjiBytes(String str, BitArray bitArray) throws WriterException {
        ...
        for (int i2 = 0; i2 < length; i2 += 2) {
            ...
            bitArray.appendBits(((i >> 8) * Wbxml.EXT_0) + (i & 255), 13);
        }
    }
