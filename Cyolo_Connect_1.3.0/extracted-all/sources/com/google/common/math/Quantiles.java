    ...
    public static final class ScaleAndIndexes {
        ...
        public Map<Integer, Double> computeInPlace(double... dArr) {
            ...
            while (true) {
                ...
                int i5 = i3;
                int i6 = (int) (length2 - (((long) iDivide) * ((long) this.scale)));
                iArr3[i5] = iDivide;
                iArr4[i5] = i6;
                iArr5[i4] = iDivide;
                i4++;
            ...
            while (true) {
                ...
                if (i < iArr7.length) {
                    ...
                    int i8 = iArr4[i];
                    if (i8 == 0) {
                        map2.put(Integer.valueOf(iArr7[i]), Double.valueOf(dArr[i7]));
                    } else {
                        map2.put(Integer.valueOf(iArr7[i]), Double.valueOf(Quantiles.interpolate(dArr[i7], dArr[i7 + 1], i8, this.scale)));
                    }
                    i++;
                } else {
