...
public final class LongMath {
    ...
    static final int[] biggestSimpleBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 2642246, 86251, 11724, 3218, 1313, 684, 419, 287, 214, 169, WKSRecord.Service.NETBIOS_SSN, 119, 105, 95, 87, 81, 76, 73, 70, 68, 66, 64, 63, 62, 62, 61, 61, 61};
    ...
    /* JADX WARN: Found duplicated region for block: B:34:0x0061  */
    /* JADX WARN: Found duplicated region for block: B:36:0x0064  */
    /* JADX WARN: Found duplicated region for block: B:38:? A[RETURN, SYNTHETIC] */
    ...
    public static long checkedPow(long j, int i) {
        ...
        if (!(j >= -2) || !(j <= 2)) {
            ...
            while (i2 != 0) {
                ...
                long jCheckedMultiply = (i2 & 1) != 0 ? checkedMultiply(j2, j3) : j2;
                int i3 = i2 >> 1;
                if (i3 > 0) {
