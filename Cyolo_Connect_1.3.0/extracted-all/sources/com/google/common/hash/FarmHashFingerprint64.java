...
final class FarmHashFingerprint64 extends AbstractNonStreamingHashFunction {
    ...
    private static long hashLength0to16(byte[] bArr, int i, int i2) {
        ...
        if (i2 >= 4) {
            return hashLength16(((long) i2) + ((((long) LittleEndianByteArray.load32(bArr, i)) & KeyboardMap.kValueMask) << 3), ((long) LittleEndianByteArray.load32(bArr, (i + i2) - 4)) & KeyboardMap.kValueMask, ((long) (i2 * 2)) + K2);
        }
        if (i2 <= 0) {
            return K2;
        }
    ...
    private static long hashLength65Plus(byte[] bArr, int i, int i2) {
        ...
        while (true) {
            ...
            if (i7 == i4) {
                ...
                return hashLength16(hashLength16(jArr[0], jArr2[0], j3) + (shiftMix(jLoad643) * K0) + j6, hashLength16(jArr[1], jArr2[1], j3) + jRotateRight6, j3);
            }
            jShiftMix = j2;
            j = jLoad642;
