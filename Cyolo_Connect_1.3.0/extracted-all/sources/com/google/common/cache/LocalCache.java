...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, j$.util.concurrent.ConcurrentMap {
    ...
    static class LoadingValueReference<K, V> implements ValueReference<K, V> {
        ...
        public ListenableFuture<V> loadFuture(K k, CacheLoader<? super K, V> cacheLoader) {
            try {
                ...
                return Futures.transform(listenableFutureReload, new com.google.common.base.Function<V, V>() { // from class: com.google.common.cache.LocalCache.LoadingValueReference.1
    ...
    /* JADX WARN: Found duplicated region for block: B:39:0x00b9  */
    @NullableDecl
    ...
    abstract class AbstractCacheSet<T> extends AbstractSet<T> {
        ...
        AbstractCacheSet(java.util.concurrent.ConcurrentMap<?, ?> concurrentMap) {
    ...
    final class KeySet extends LocalCache<K, V>.AbstractCacheSet<K> {
        KeySet(java.util.concurrent.ConcurrentMap<?, ?> concurrentMap) {
            super(concurrentMap);
        }
    ...
    final class Values extends AbstractCollection<V> {
        ...
        Values(java.util.concurrent.ConcurrentMap<?, ?> concurrentMap) {
            this.map = concurrentMap;
        }
    ...
    final class EntrySet extends LocalCache<K, V>.AbstractCacheSet<Map.Entry<K, V>> {
        EntrySet(java.util.concurrent.ConcurrentMap<?, ?> concurrentMap) {
            super(concurrentMap);
        }
