...
public abstract class ImmutableTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    static <R, C, V> Table.Cell<R, C, V> cellOf(R r, C c, V v) {
        return Tables.immutableCell(Preconditions.checkNotNull(r, "rowKey"), Preconditions.checkNotNull(c, "columnKey"), Preconditions.checkNotNull(v, MainActivityKt.INTENT_SERVICE_STATUS_EXTRA_VALUE));
    }
    ...
    public static final class Builder<R, C, V> {
        ...
        public Builder<R, C, V> put(Table.Cell<? extends R, ? extends C, ? extends V> cell) {
            if (cell instanceof Tables.ImmutableCell) {
                ...
                Preconditions.checkNotNull(cell.getValue(), MainActivityKt.INTENT_SERVICE_STATUS_EXTRA_VALUE);
                this.cells.add(cell);
            } else {
