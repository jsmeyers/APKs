    ...
    private static ArrayList<MessageDetails> readMessages(ArrayList<Map<String, Object>> arrayList) {
        ...
        if (arrayList != null) {
            for (Map<String, Object> map : arrayList) {
                arrayList2.add(new MessageDetails((String) map.get(TEXT), (Long) map.get(TIMESTAMP), readPersonDetails((Map) map.get(PERSON)), (String) map.get(DATA_MIME_TYPE), (String) map.get(DATA_URI)));
            }
        }
        return arrayList2;
    }
