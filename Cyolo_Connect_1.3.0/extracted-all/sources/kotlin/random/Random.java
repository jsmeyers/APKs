...
public abstract class Random {
    ...
    public long nextLong(long from, long until) {
        ...
        if (((-j2) & j2) == j2) {
            ...
            if (i != 0) {
                ...
                jNextBits = (((long) nextBits(RandomKt.fastLog2(i2))) << 32) + (((long) nextInt()) & KeyboardMap.kValueMask);
            }
            jNextBits = ((long) iNextInt) & KeyboardMap.kValueMask;
        } else {
            do {
    ...
    /* JADX WARN: Found duplicated region for block: B:19:0x003e  */
