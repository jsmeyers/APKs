...
public class Base64 {
    ...
    /* JADX WARN: Found duplicated region for block: B:18:0x0078 A[DONT_INVERT] */
    /* JADX WARN: Found duplicated region for block: B:20:0x007f  */
    /* JADX WARN: Found duplicated region for block: B:22:0x0083  */
    /* JADX WARN: Found duplicated region for block: B:25:0x00b2  */
    /* JADX WARN: Found duplicated region for block: B:27:0x00bc  */
    /* JADX WARN: Found duplicated region for block: B:39:0x007a A[SYNTHETIC] */
    /* JADX WARN: Found duplicated region for block: B:40:0x0086 A[SYNTHETIC] */
    /* JADX WARN: Found duplicated region for block: B:44:0x00cb A[SYNTHETIC] */
    private final int decodeImpl(byte[] source, byte[] destination, int destinationOffset, int startIndex, int endIndex) {
        ...
        while (iHandlePaddingSymbol < endIndex) {
            if (i6 == i3 && iHandlePaddingSymbol + 3 < endIndex) {
                int i7 = iHandlePaddingSymbol + 1;
                int i8 = iArr[source[iHandlePaddingSymbol] & 255];
                int i9 = i7 + 1;
                int i10 = iArr[source[i7] & 255];
                int i11 = i9 + 1;
                int i12 = iArr[source[i9] & 255];
                int i13 = i11 + 1;
                int i14 = (i12 << 6) | (i8 << 18) | (i10 << 12) | iArr[source[i11] & 255];
                if (i14 >= 0) {
                    int i15 = i4 + 1;
        ...
        int i17 = source[iSkipIllegalSymbolsIfMime] & 255;
