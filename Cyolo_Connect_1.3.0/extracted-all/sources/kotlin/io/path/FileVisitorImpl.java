...
final class FileVisitorImpl extends SimpleFileVisitor<Path> {
    ...
    public /* bridge */ /* synthetic */ FileVisitResult visitFileFailed(Object obj, IOException iOException) {
        return visitFileFailed(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1668m(obj), iOException);
    }
    ...
    public FileVisitResult preVisitDirectory(Path dir, BasicFileAttributes attrs) throws IOException {
        FileVisitResult fileVisitResultM1664m;
        Intrinsics.checkNotNullParameter(dir, "dir");
        Intrinsics.checkNotNullParameter(attrs, "attrs");
        Function2<Path, BasicFileAttributes, FileVisitResult> function2 = this.onPreVisitDirectory;
        if (function2 != null && (fileVisitResultM1664m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1664m((Object) function2.invoke(dir, attrs))) != null) {
            return fileVisitResultM1664m;
        }
    ...
    public FileVisitResult visitFile(Path file, BasicFileAttributes attrs) throws IOException {
        ...
        if (function2 != null && (fileVisitResultM1664m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1664m((Object) function2.invoke(file, attrs))) != null) {
            return fileVisitResultM1664m;
        }
    ...
    public FileVisitResult visitFileFailed(Path file, IOException exc) throws IOException {
        ...
        if (function2 != null && (fileVisitResultM1664m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1664m((Object) function2.invoke(file, exc))) != null) {
            return fileVisitResultM1664m;
        }
    ...
    public FileVisitResult postVisitDirectory(Path dir, IOException exc) throws IOException {
        ...
        if (function2 != null && (fileVisitResultM1664m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1664m((Object) function2.invoke(dir, exc))) != null) {
            return fileVisitResultM1664m;
        }
