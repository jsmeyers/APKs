...
class PathsKt__PathUtilsKt extends PathsKt__PathRecursiveFunctionsKt {
    ...
    public static final List<Path> listDirectoryEntries(Path path, String glob) throws IOException {
        ...
        try {
            DirectoryStream it = NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m2208m((Object) directoryStreamNewDirectoryStream);
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesViewOrNull(Path path, LinkOption... options) {
        ...
        return (V) Files.getFileAttributeView(path, NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m2206m(), (LinkOption[]) Arrays.copyOf(options, options.length));
    }
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesView(Path path, LinkOption... options) {
        ...
        Intrinsics.checkNotNullParameter(options, "options");
        Intrinsics.reifiedOperationMarker(4, "V");
        FileAttributeView fileAttributeView = Files.getFileAttributeView(path, NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m2206m(), (LinkOption[]) Arrays.copyOf(options, options.length));
        if (fileAttributeView != null) {
            return (V) NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m2219m((Object) fileAttributeView);
        }
        Intrinsics.reifiedOperationMarker(4, "V");
        PathsKt.fileAttributeViewNotAvailable(path, NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m2206m());
    ...
    private static final /* synthetic */ <A extends BasicFileAttributes> A readAttributes(Path path, LinkOption... options) throws IOException {
        ...
        BasicFileAttributes attributes = Files.readAttributes(path, (Class<BasicFileAttributes>) PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$1(), (LinkOption[]) Arrays.copyOf(options, options.length));
        Intrinsics.checkNotNullExpressionValue(attributes, "readAttributes(this, A::class.java, *options)");
        return (A) NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m2217m((Object) attributes);
    }
