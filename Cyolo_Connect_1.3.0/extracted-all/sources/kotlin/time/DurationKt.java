...
public final class DurationKt {
    ...
    private static final long m1928timesmvk6XK0(int i, long j) {
        return Duration.m1839timesUwyO8pc(j, i);
    }

    /* JADX INFO: renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m1927timeskIfJnKk(double d, long j) {
        return Duration.m1838timesUwyO8pc(j, d);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Found duplicated region for block: B:171:0x00af A[EDGE_INSN: B:171:0x00af->B:49:0x00af BREAK  A[LOOP:1: B:36:0x006d->B:47:0x009f], SYNTHETIC] */
    /* JADX WARN: Found duplicated region for block: B:47:0x009f A[LOOP:1: B:36:0x006d->B:47:0x009f, LOOP_END] */
    public static final long parseDuration(String str, boolean z) {
        ...
        long jM1904getZEROUwyO8pc = Duration.INSTANCE.m1904getZEROUwyO8pc();
        ...
        if (str.charAt(length2) == 'P') {
            ...
            while (i3 < length) {
                if (str.charAt(i3) != 'T') {
                    ...
                    if (durationUnitDurationUnitByIsoChar == DurationUnit.SECONDS && iIndexOf$default > 0) {
                        ...
                        long jM1837plusLRDsOJo = Duration.m1837plusLRDsOJo(jM1904getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM1904getZEROUwyO8pc = Duration.m1837plusLRDsOJo(jM1837plusLRDsOJo, toDuration(Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    } else {
                        jM1904getZEROUwyO8pc = Duration.m1837plusLRDsOJo(jM1904getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    }
            ...
            if (StringsKt.regionMatches(str, length2, "Infinity", 0, Math.max(length - length2, 8), true)) {
                jM1904getZEROUwyO8pc = Duration.INSTANCE.m1902getINFINITEUwyO8pc();
            } else {
                boolean z8 = !z5;
                ...
                while (length2 < i) {
                    ...
                    if (iIndexOf$default2 > 0) {
                        ...
                        long jM1837plusLRDsOJo2 = Duration.m1837plusLRDsOJo(jM1904getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        Intrinsics.checkNotNull(strSubstring4, "null cannot be cast to non-null type java.lang.String");
                        String strSubstring7 = strSubstring4.substring(iIndexOf$default2);
                        String str6 = str4;
                        Intrinsics.checkNotNullExpressionValue(strSubstring7, str6);
                        jM1904getZEROUwyO8pc = Duration.m1837plusLRDsOJo(jM1837plusLRDsOJo2, toDuration(Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < i) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                        str4 = str6;
                    } else {
                        jM1904getZEROUwyO8pc = Duration.m1837plusLRDsOJo(jM1904getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                    }
        ...
        return z2 ? Duration.m1854unaryMinusUwyO8pc(jM1904getZEROUwyO8pc) : jM1904getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m1801constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m1801constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m1801constructorimpl((j << 1) + ((long) i));
    }
