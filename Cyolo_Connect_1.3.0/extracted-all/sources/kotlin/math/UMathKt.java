...
public final class UMathKt {
    ...
    private static final int m1688minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1638minOfJ1ME1BU(i, i2);
    }

    /* JADX INFO: renamed from: min-eb3DHEI, reason: not valid java name */
    private static final long m1689mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m1646minOfeb3DHEI(j, j2);
    }

    /* JADX INFO: renamed from: max-J1ME1BU, reason: not valid java name */
    private static final int m1686maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1626maxOfJ1ME1BU(i, i2);
    }

    /* JADX INFO: renamed from: max-eb3DHEI, reason: not valid java name */
    private static final long m1687maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m1634maxOfeb3DHEI(j, j2);
    }
}
