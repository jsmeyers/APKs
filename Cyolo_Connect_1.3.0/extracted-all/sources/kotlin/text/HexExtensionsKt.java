...
public final class HexExtensionsKt {
    ...
    /* JADX WARN: Found duplicated region for block: B:19:0x0080  */
    /* JADX WARN: Found duplicated region for block: B:32:0x0083 A[SYNTHETIC] */
    ...
    public static final int formattedStringLength(int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        ...
        throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m663toStringimpl(ULong.m617constructorimpl(j))));
    }
