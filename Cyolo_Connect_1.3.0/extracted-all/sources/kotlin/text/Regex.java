...
public final class Regex implements Serializable {
    ...
    public final Sequence<String> splitToSequence(CharSequence input, int limit) {
        Intrinsics.checkNotNullParameter(input, "input");
        StringsKt.requireNonNegativeLimit(limit);
        return SequencesKt.sequence(new C01141(input, limit, null));
    }
    ...
    static final class C01141 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super String>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01141(CharSequence charSequence, int i, Continuation<? super C01141> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C01141 c01141 = Regex.this.new C01141(this.$input, this.$limit, continuation);
            c01141.L$0 = obj;
            return c01141;
        }
        ...
        /* JADX WARN: Found duplicated region for block: B:20:0x0075 A[RETURN] */
        /* JADX WARN: Found duplicated region for block: B:23:0x0080  */
        /* JADX WARN: Found duplicated region for block: B:27:0x00a4 A[RETURN] */
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i2 == 0) {
                ...
                if (this.$limit == 1 || !matcher2.find()) {
                    ...
                    matcher = matcher2;
                    i = 0;
                    c01141.L$0 = sequenceScope;
                    c01141.L$1 = matcher;
                    c01141.I$0 = i;
                    c01141.label = 2;
                    if (sequenceScope.yield(c01141.$input.subSequence(iEnd, matcher.start()).toString(), c01141) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    iEnd = matcher.end();
                    i++;
                    ...
                    charSequence = c01141.$input;
                    c01141.L$0 = null;
                    c01141.L$1 = null;
                    c01141.label = 3;
                    if (sequenceScope.yield(charSequence.subSequence(iEnd, charSequence.length()).toString(), c01141) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                ...
                if (i2 != 1) {
                    if (i2 == 2) {
                        ...
                        iEnd = matcher.end();
                        i++;
                        if (i != c01141.$limit - 1 || !matcher.find()) {
                            charSequence = c01141.$input;
                            c01141.L$0 = null;
                            c01141.L$1 = null;
                            c01141.label = 3;
