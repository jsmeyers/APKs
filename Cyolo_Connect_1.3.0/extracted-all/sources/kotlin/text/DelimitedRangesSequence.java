...
final class DelimitedRangesSequence implements Sequence<IntRange> {
    ...
    public static final class AnonymousClass1 implements Iterator<IntRange>, KMappedMarker {
        ...
        /* JADX WARN: Found duplicated region for block: B:11:0x0031 A[ADDED_TO_REGION, REMOVE] */
        /* JADX WARN: Found duplicated region for block: B:17:0x0098  */
        /* JADX WARN: Found duplicated region for block: B:9:0x0023  */
        private final void calcNext() {
            ...
            if (this.nextSearchIndex >= 0) {
                if (DelimitedRangesSequence.this.limit > 0) {
                    ...
                    int iIntValue22 = ((Number) pair.component2()).intValue();
                    this.nextItem = RangesKt.until(this.currentStartIndex, iIntValue3);
                    int i22 = iIntValue3 + iIntValue22;
                    this.currentStartIndex = i22;
                    this.nextSearchIndex = i22 + (iIntValue22 == 0 ? 1 : 0);
                }
                this.nextState = 1;
                return;
            }
