...
public final class Utf8 {
        ...
        while (i < i2) {
            ...
            if (Intrinsics.compare((int) cCharAt, 128) < 0) {
                ...
                if (Intrinsics.compare((int) cCharAt, 2048) < 0) {
                    yield.invoke(Byte.valueOf((byte) ((cCharAt >> 6) | Wbxml.EXT_0)));
    ...
    /* JADX WARN: Found duplicated region for block: B:102:0x016f  */
                        ...
                        if ((b4 & 192) == 128) {
                            ...
                            if ((b5 & 192) == 128) {
                                ...
                                if (i9 >= 2048) {
                                    ...
                                    numValueOf = z ? Integer.valueOf(REPLACEMENT_CODE_POINT) : Integer.valueOf(i9);
                                }
                            ...
                            if ((b7 & 192) == 128) {
                                ...
                                if ((b8 & 192) == 128) {
                                    ...
                                    if (i13 <= 1114111) {
                                        ...
                                        numValueOf2 = (!z && i13 >= 65536) ? Integer.valueOf(i13) : Integer.valueOf(REPLACEMENT_CODE_POINT);
                                    }
    ...
    /* JADX WARN: Found duplicated region for block: B:54:0x00d2  */
                        ...
                        if ((b4 & 192) == 128) {
                            ...
                            if ((b5 & 192) == 128) {
                                ...
                                if (i9 >= 2048) {
                                    ...
                                    c = z ? (char) REPLACEMENT_CODE_POINT : (char) i9;
                                }
