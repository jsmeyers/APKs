...
public final class NioSystemFileSystem extends JvmSystemFileSystem {
    ...
    public FileMetadata metadataOrNull(Path path) throws IOException {
        java.nio.file.Path pathM1668m;
        Intrinsics.checkNotNullParameter(path, "path");
        java.nio.file.Path nioPath = path.toNioPath();
        try {
            BasicFileAttributes attributes = Files.readAttributes(nioPath, (Class<BasicFileAttributes>) PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$1(), LinkOption.NOFOLLOW_LINKS);
            if (attributes.isSymbolicLink()) {
                pathM1668m = Files.readSymbolicLink(nioPath);
            } else {
                pathM1668m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1668m((Object) null);
            }
            boolean zIsRegularFile = attributes.isRegularFile();
            boolean zIsDirectory = attributes.isDirectory();
            Path path2 = pathM1668m == null ? null : Path.Companion.get$default(Path.INSTANCE, pathM1668m, false, 1, (Object) null);
    ...
    public void atomicMove(Path source, Path target) throws IOException {
        ...
        try {
            Files.move(source.toNioPath(), target.toNioPath(), NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m((Object) StandardCopyOption.ATOMIC_MOVE), NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m((Object) StandardCopyOption.REPLACE_EXISTING));
