...
public final class _BufferKt {
    ...
    public static final Buffer commonWriteUtf8CodePoint(Buffer buffer, int i) {
        ...
        if (i < 128) {
            ...
            segmentWritableSegment$okio.data[segmentWritableSegment$okio.limit] = (byte) ((i >> 6) | Wbxml.EXT_0);
    ...
    public static final long commonIndexOf(Buffer buffer, byte b, long j, long j2) {
        ...
        if (buffer.size() - j3 < j3) {
            ...
            while (size2 < j5) {
                byte[] bArr = segment.data;
                int iMin = (int) Math.min(segment.limit, (((long) segment.pos) + j5) - size2);
                for (int i = (int) ((((long) segment.pos) + j3) - size2); i < iMin; i++) {
                    if (bArr[i] == b) {
        ...
        while (j4 < j5) {
            byte[] bArr2 = segment.data;
            int iMin2 = (int) Math.min(segment.limit, (((long) segment.pos) + j5) - j4);
            for (int i2 = (int) ((((long) segment.pos) + j3) - j4); i2 < iMin2; i2++) {
                if (bArr2[i2] == b) {
    ...
    public static final long commonIndexOf(Buffer buffer, ByteString bytes, long j) {
        ...
        if (buffer.size() - j < j) {
            ...
            while (j4 < size3) {
                byte[] bArr = segment2.data;
                Segment segment3 = segment2;
                int iMin = (int) Math.min(segment2.limit, (((long) segment2.pos) + size3) - j4);
                int i = (int) ((((long) segment3.pos) + j5) - j4);
                if (i < iMin) {
                    while (true) {
                        int i2 = i + 1;
                        if (bArr[i] == b && rangeEquals(segment3, i2, bArrInternalArray$okio, 1, size2)) {
                            return ((long) (i - segment3.pos)) + j4;
                        }
                        if (i2 >= iMin) {
                            break;
                        }
        ...
        while (j7 < size5) {
            byte[] bArr2 = segment4.data;
            long j9 = size5;
            int iMin2 = (int) Math.min(segment4.limit, (((long) segment4.pos) + size5) - j7);
            int i3 = (int) ((((long) segment4.pos) + j8) - j7);
            if (i3 < iMin2) {
                while (true) {
                    int i4 = i3 + 1;
                    if (bArr2[i3] == b2 && rangeEquals(segment4, i4, bArrInternalArray$okio2, 1, size4)) {
                        return ((long) (i3 - segment4.pos)) + j7;
                    }
                    if (i4 >= iMin2) {
                        break;
                    }
            ...
            j7 += (long) (segment4.limit - segment4.pos);
