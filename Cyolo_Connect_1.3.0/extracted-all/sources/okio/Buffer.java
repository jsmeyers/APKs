...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public String readString(long byteCount, Charset charset) throws EOFException {
        Intrinsics.checkNotNullParameter(charset, "charset");
        if (!(byteCount >= 0 && byteCount <= TTL.MAX_VALUE)) {
    ...
    public final byte m2185deprecated_getByte(long index) {
        ...
        while (beginIndex < endIndex) {
            ...
            if (cCharAt2 < 128) {
                ...
                if (cCharAt2 < 2048) {
                    ...
                    segmentWritableSegment$okio2.data[segmentWritableSegment$okio2.limit] = (byte) ((cCharAt2 >> 6) | Wbxml.EXT_0);
    ...
    public Buffer writeUtf8CodePoint(int codePoint) {
        if (codePoint < 128) {
            ...
            segmentWritableSegment$okio.data[segmentWritableSegment$okio.limit] = (byte) ((codePoint >> 6) | Wbxml.EXT_0);
    ...
    public long indexOf(byte b, long fromIndex, long toIndex) {
        ...
        if (!z) {
            throw new IllegalArgumentException(("size=" + size() + " fromIndex=" + j + " toIndex=" + size).toString());
        }
        if (size > size()) {
            size = size();
        }
        ...
        if (size() - j < j) {
            ...
            while (size2 < j2) {
                byte[] bArr = segment.data;
                int iMin = (int) Math.min(segment.limit, (((long) segment.pos) + j2) - size2);
                i = (int) ((((long) segment.pos) + j) - size2);
                while (i < iMin) {
                    if (bArr[i] != b) {
                        i++;
                    }
        ...
        while (true) {
            long j3 = ((long) (segment.limit - segment.pos)) + size2;
            if (j3 > j) {
                break;
            }
            segment = segment.next;
        ...
        while (size2 < j2) {
            ...
            int iMin2 = (int) Math.min(segment.limit, (((long) segment.pos) + j2) - size2);
            i = (int) ((((long) segment.pos) + j) - size2);
            while (i < iMin2) {
                if (bArr2[i] != b) {
                    i++;
        ...
        if (segment == null) {
            ...
            if (segment != null) {
                ...
                while (j2 < size3) {
                    byte[] bArr = segment2.data;
                    long j4 = j3;
                    int iMin = (int) Math.min(segment2.limit, (((long) segment2.pos) + size3) - j2);
                    int i = (int) ((((long) segment2.pos) + j4) - j2);
                    if (i < iMin) {
                        while (true) {
                            int i2 = i + 1;
                            if (bArr[i] == b && _BufferKt.rangeEquals(segment2, i2, bArrInternalArray$okio, 1, size2)) {
                                return ((long) (i - segment2.pos)) + j2;
                            }
                            if (i2 >= iMin) {
                                break;
                            }
            ...
            while (true) {
                long j5 = ((long) (segment.limit - segment.pos)) + j;
                if (j5 > fromIndex) {
                    break;
                }
                segment = segment.next;
            ...
            if (segment != null) {
                ...
                while (j6 < size5) {
                    ...
                    int i3 = (int) ((((long) segment.pos) + j7) - j6);
                    if (i3 < iMin2) {
                        while (true) {
                            int i4 = i3 + 1;
