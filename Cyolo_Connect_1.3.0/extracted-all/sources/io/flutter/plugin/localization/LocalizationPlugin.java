    ...
    public Locale resolveNativeLocale(List<Locale> list) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                arrayList.add(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1673m(language));
                PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1682m$1();
                arrayList.add(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1673m(locale.getLanguage()));
                PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1682m$1();
                arrayList.add(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1673m(locale.getLanguage() + "-*"));
            }
