...
public class PlatformViewsController implements PlatformViewsAccessibilityDelegate {
    ...
    class AnonymousClass1 implements PlatformViewsChannel.PlatformViewsHandler {
            ...
            if (PlatformViewsController.this.usesVirtualDisplay(i)) {
                ...
                virtualDisplayController.resize(physicalPixels, physicalPixels2, new Runnable() { // from class: io.flutter.plugin.platform.PlatformViewsController$1$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        this.f$0.m393x7b26d3(virtualDisplayController, displayDensity, platformViewBufferResized);
                    }
                });
                return;
            }
        ...
        /* JADX INFO: renamed from: lambda$resize$0$io-flutter-plugin-platform-PlatformViewsController$1, reason: not valid java name */
        /* synthetic */ void m393x7b26d3(VirtualDisplayController virtualDisplayController, float f, PlatformViewsChannel.PlatformViewBufferResized platformViewBufferResized) {
    ...
    public long configureForVirtualDisplay(PlatformView platformView, final PlatformViewsChannel.PlatformViewCreationRequest platformViewCreationRequest) {
        ...
        VirtualDisplayController virtualDisplayControllerCreate = VirtualDisplayController.create(this.context, this.accessibilityEventsDelegate, platformView, platformViewRenderTargetMakePlatformViewRenderTarget, toPhysicalPixels(platformViewCreationRequest.logicalWidth), toPhysicalPixels(platformViewCreationRequest.logicalHeight), platformViewCreationRequest.viewId, null, new View.OnFocusChangeListener() { // from class: io.flutter.plugin.platform.PlatformViewsController$$ExternalSyntheticLambda3
            ...
            public final void onFocusChange(View view, boolean z) {
                this.f$0.m390x9514d2a0(platformViewCreationRequest, view, z);
            }
        });
    ...
    /* JADX INFO: renamed from: lambda$configureForVirtualDisplay$0$io-flutter-plugin-platform-PlatformViewsController, reason: not valid java name */
    /* synthetic */ void m390x9514d2a0(PlatformViewsChannel.PlatformViewCreationRequest platformViewCreationRequest, View view, boolean z) {
        if (z) {
    ...
    public long configureForTextureLayerComposition(PlatformView platformView, final PlatformViewsChannel.PlatformViewCreationRequest platformViewCreationRequest) {
        ...
        platformViewWrapper.setOnDescendantFocusChangeListener(new View.OnFocusChangeListener() { // from class: io.flutter.plugin.platform.PlatformViewsController$$ExternalSyntheticLambda1
            ...
            public final void onFocusChange(View view2, boolean z) {
                this.f$0.m389x6d74e942(platformViewCreationRequest, view2, z);
            }
        });
    ...
    /* JADX INFO: renamed from: lambda$configureForTextureLayerComposition$1$io-flutter-plugin-platform-PlatformViewsController, reason: not valid java name */
    /* synthetic */ void m389x6d74e942(PlatformViewsChannel.PlatformViewCreationRequest platformViewCreationRequest, View view, boolean z) {
        if (z) {
            this.platformViewsChannel.invokeViewFocused(platformViewCreationRequest.viewId);
            return;
        }
    ...
    void initializePlatformViewIfNeeded(final int i) {
        ...
        flutterMutatorView.setOnDescendantFocusChangeListener(new View.OnFocusChangeListener() { // from class: io.flutter.plugin.platform.PlatformViewsController$$ExternalSyntheticLambda0
            @Override // android.view.View.OnFocusChangeListener
            public final void onFocusChange(View view2, boolean z) {
                this.f$0.m391x63d72b3e(i, view2, z);
            }
        });
    ...
    /* JADX INFO: renamed from: lambda$initializePlatformViewIfNeeded$2$io-flutter-plugin-platform-PlatformViewsController, reason: not valid java name */
    /* synthetic */ void m391x63d72b3e(int i, View view, boolean z) {
        if (z) {
    ...
    /* JADX INFO: renamed from: lambda$onEndFrame$3$io-flutter-plugin-platform-PlatformViewsController, reason: not valid java name */
    /* synthetic */ void m392x3ce3c1e6() {
        finishFrame(false);
    }
