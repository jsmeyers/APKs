...
public class FlutterView extends FrameLayout implements MouseCursorPlugin.MouseCursorViewDelegate, KeyboardManager.ViewDelegate {
    ...
    public final WindowInsets onApplyWindowInsets(WindowInsets windowInsets) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            int iNavigationBars = z2 ? 0 | WindowInsets.Type.navigationBars() : 0;
            if (z) {
    ...
    void sendUserSettingsToFlutter() {
        ...
        if (this.textServicesManager != null) {
            if (Build.VERSION.SDK_INT >= 31) {
                z = this.textServicesManager.isSpellCheckerEnabled() && Collection.EL.stream(this.textServicesManager.getEnabledSpellCheckerInfos()).anyMatch(new Predicate() { // from class: io.flutter.embedding.android.FlutterView$$ExternalSyntheticLambda7
