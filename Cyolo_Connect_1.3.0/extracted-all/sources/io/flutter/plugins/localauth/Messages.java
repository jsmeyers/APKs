...
public class Messages {
    ...
    public static final class AuthClassificationWrapper {
        ...
        public void setValue(AuthClassification authClassification) {
        ...
        public static final class Builder {
            ...
            public Builder setValue(AuthClassification authClassification) {
                this.value = authClassification;
                return this;
            }
        ...
        static AuthClassificationWrapper fromList(ArrayList<Object> arrayList) {
            AuthClassificationWrapper authClassificationWrapper = new AuthClassificationWrapper();
    ...
    public interface LocalAuthApi {
        ...
        public final /* synthetic */ class CC {
            ...
            public static void setup(BinaryMessenger binaryMessenger, final LocalAuthApi localAuthApi) {
                BasicMessageChannel basicMessageChannel = new BasicMessageChannel(binaryMessenger, "dev.flutter.pigeon.local_auth_android.LocalAuthApi.isDeviceSupported", getCodec());
                if (localAuthApi != null) {
                    basicMessageChannel.setMessageHandler(new BasicMessageChannel.MessageHandler() { // from class: io.flutter.plugins.localauth.Messages$LocalAuthApi$$ExternalSyntheticLambda0
                        ...
                        public final void onMessage(Object obj, BasicMessageChannel.Reply reply) {
                            Messages.LocalAuthApi.CC.lambda$setup$0(localAuthApi, obj, reply);
                        }
                    });
                } else {
                    basicMessageChannel.setMessageHandler(null);
                }
                BasicMessageChannel basicMessageChannel2 = new BasicMessageChannel(binaryMessenger, "dev.flutter.pigeon.local_auth_android.LocalAuthApi.deviceCanSupportBiometrics", getCodec());
                if (localAuthApi != null) {
                    basicMessageChannel2.setMessageHandler(new BasicMessageChannel.MessageHandler() { // from class: io.flutter.plugins.localauth.Messages$LocalAuthApi$$ExternalSyntheticLambda1
                        @Override // io.flutter.plugin.common.BasicMessageChannel.MessageHandler
                        public final void onMessage(Object obj, BasicMessageChannel.Reply reply) {
                            Messages.LocalAuthApi.CC.lambda$setup$1(localAuthApi, obj, reply);
                        }
                    });
                } else {
                    basicMessageChannel2.setMessageHandler(null);
                }
                BasicMessageChannel basicMessageChannel3 = new BasicMessageChannel(binaryMessenger, "dev.flutter.pigeon.local_auth_android.LocalAuthApi.stopAuthentication", getCodec());
                if (localAuthApi != null) {
                    basicMessageChannel3.setMessageHandler(new BasicMessageChannel.MessageHandler() { // from class: io.flutter.plugins.localauth.Messages$LocalAuthApi$$ExternalSyntheticLambda2
                        @Override // io.flutter.plugin.common.BasicMessageChannel.MessageHandler
                        public final void onMessage(Object obj, BasicMessageChannel.Reply reply) {
                            Messages.LocalAuthApi.CC.lambda$setup$2(localAuthApi, obj, reply);
                        }
                    });
                } else {
                    basicMessageChannel3.setMessageHandler(null);
                }
                BasicMessageChannel basicMessageChannel4 = new BasicMessageChannel(binaryMessenger, "dev.flutter.pigeon.local_auth_android.LocalAuthApi.getEnrolledBiometrics", getCodec());
                if (localAuthApi != null) {
                    basicMessageChannel4.setMessageHandler(new BasicMessageChannel.MessageHandler() { // from class: io.flutter.plugins.localauth.Messages$LocalAuthApi$$ExternalSyntheticLambda3
                        @Override // io.flutter.plugin.common.BasicMessageChannel.MessageHandler
                        public final void onMessage(Object obj, BasicMessageChannel.Reply reply) {
                            Messages.LocalAuthApi.CC.lambda$setup$3(localAuthApi, obj, reply);
                        }
                    });
                } else {
                    basicMessageChannel4.setMessageHandler(null);
                }
                BasicMessageChannel basicMessageChannel5 = new BasicMessageChannel(binaryMessenger, "dev.flutter.pigeon.local_auth_android.LocalAuthApi.authenticate", getCodec());
                if (localAuthApi != null) {
                    basicMessageChannel5.setMessageHandler(new BasicMessageChannel.MessageHandler() { // from class: io.flutter.plugins.localauth.Messages$LocalAuthApi$$ExternalSyntheticLambda4
                        @Override // io.flutter.plugin.common.BasicMessageChannel.MessageHandler
                        public final void onMessage(Object obj, BasicMessageChannel.Reply reply) {
                            Messages.LocalAuthApi.CC.lambda$setup$4(localAuthApi, obj, reply);
                        }
                    });
                } else {
