...
class AuthenticationHelper extends BiometricPrompt.AuthenticationCallback implements Application.ActivityLifecycleCallbacks, DefaultLifecycleObserver {
    ...
    /* JADX WARN: Found duplicated region for block: B:25:0x0035  */
    /* JADX WARN: Found duplicated region for block: B:27:0x0039  */
    /* JADX WARN: Found duplicated region for block: B:29:0x0049  */
    /* JADX WARN: Found duplicated region for block: B:37:0x007d  */
    @Override // androidx.biometric.BiometricPrompt.AuthenticationCallback
        ...
        if (this.isAuthSticky) {
            ...
            this.uiThreadExecutor.handler.post(new Runnable() { // from class: io.flutter.plugins.localauth.AuthenticationHelper$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m412xbbbb94b9(biometricPrompt);
                }
            });
        }
    }

    /* JADX INFO: renamed from: lambda$onActivityResumed$0$io-flutter-plugins-localauth-AuthenticationHelper, reason: not valid java name */
    /* synthetic */ void m412xbbbb94b9(BiometricPrompt biometricPrompt) {
        biometricPrompt.authenticate(this.promptInfo);
    }
    ...
    private void showGoToSettingsDialog(String str, String str2) {
        ...
        DialogInterface.OnClickListener onClickListener = new DialogInterface.OnClickListener() { // from class: io.flutter.plugins.localauth.AuthenticationHelper$$ExternalSyntheticLambda1
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                this.f$0.m413xd70b7f36(dialogInterface, i);
            }
        };
        new AlertDialog.Builder(contextThemeWrapper).setView(viewInflate).setPositiveButton(this.strings.getGoToSettingsButton(), onClickListener).setNegativeButton(this.strings.getCancelButton(), new DialogInterface.OnClickListener() { // from class: io.flutter.plugins.localauth.AuthenticationHelper$$ExternalSyntheticLambda2
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                this.f$0.m414x1a969cf7(dialogInterface, i);
            }
        }).setCancelable(false).show();
    }

    /* JADX INFO: renamed from: lambda$showGoToSettingsDialog$1$io-flutter-plugins-localauth-AuthenticationHelper, reason: not valid java name */
    /* synthetic */ void m413xd70b7f36(DialogInterface dialogInterface, int i) {
        this.completionHandler.complete(Messages.AuthResult.FAILURE);
        stop();
        this.activity.startActivity(new Intent("android.settings.SECURITY_SETTINGS"));
    }

    /* JADX INFO: renamed from: lambda$showGoToSettingsDialog$2$io-flutter-plugins-localauth-AuthenticationHelper, reason: not valid java name */
    /* synthetic */ void m414x1a969cf7(DialogInterface dialogInterface, int i) {
        this.completionHandler.complete(Messages.AuthResult.FAILURE);
        stop();
    }
