...
public class FlutterFirebaseMessagingBackgroundService extends JobIntentService {
    ...
    public static void enqueueMessageProcessing(Context context, Intent intent) {
        enqueueWork(context, FlutterFirebaseMessagingBackgroundService.class, 2020, intent, ((RemoteMessage) ((Bundle) Objects.requireNonNull(intent.getExtras())).get("notification")).getOriginalPriority() == 1);
    }
