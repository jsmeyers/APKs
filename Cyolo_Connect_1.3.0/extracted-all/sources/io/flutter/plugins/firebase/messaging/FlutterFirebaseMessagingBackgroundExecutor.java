    ...
    public void startBackgroundIsolate(final long j, final FlutterShellArgs flutterShellArgs) {
        ...
        handler.post(new Runnable() { // from class: io.flutter.plugins.firebase.messaging.FlutterFirebaseMessagingBackgroundExecutor$$ExternalSyntheticLambda1
            ...
            public final void run() {
                this.f$0.m403x4717c52b(flutterLoader, handler, flutterShellArgs, j);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$startBackgroundIsolate$1$io-flutter-plugins-firebase-messaging-FlutterFirebaseMessagingBackgroundExecutor, reason: not valid java name */
    /* synthetic */ void m403x4717c52b(final FlutterLoader flutterLoader, Handler handler, final FlutterShellArgs flutterShellArgs, final long j) {
        ...
        flutterLoader.ensureInitializationCompleteAsync(ContextHolder.getApplicationContext(), null, handler, new Runnable() { // from class: io.flutter.plugins.firebase.messaging.FlutterFirebaseMessagingBackgroundExecutor$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m402x18665b0c(flutterLoader, flutterShellArgs, j);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$startBackgroundIsolate$0$io-flutter-plugins-firebase-messaging-FlutterFirebaseMessagingBackgroundExecutor, reason: not valid java name */
    /* synthetic */ void m402x18665b0c(FlutterLoader flutterLoader, FlutterShellArgs flutterShellArgs, long j) {
