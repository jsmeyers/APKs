...
public class WKSRecord extends Record {
    ...
    public static class Protocol {
        ...
        static {
            ...
            protocols.add(3, "ggp");
            protocols.add(5, DynamicLink.SocialMetaTagParameters.KEY_SOCIAL_TITLE);
            protocols.add(6, "tcp");
            protocols.add(7, "ucl");
            protocols.add(8, "egp");
            protocols.add(9, "igp");
    ...
    public static class Service {
        ...
        static {
            ...
            services.add(53, DynamicLink.Builder.KEY_DOMAIN);
            ...
            services.add(LINK, DynamicLink.Builder.KEY_LINK);
        }
