...
public final class LocalDate implements Temporal, TemporalAdjuster, ChronoLocalDate, Serializable {
    ...
    public int compareTo(ChronoLocalDate chronoLocalDate) {
        return chronoLocalDate instanceof LocalDate ? compareTo0((LocalDate) chronoLocalDate) : ChronoLocalDate.CC.$default$compareTo(this, chronoLocalDate);
    }
    ...
    public DayOfWeek getDayOfWeek() {
        return DayOfWeek.of(((int) Clock$TickClock$$ExternalSyntheticBackport0.m(toEpochDay() + 3, 7L)) + 1);
    }
    ...
    public LocalDate plus(long j, TemporalUnit temporalUnit) {
        ...
        switch (AnonymousClass1.$SwitchMap$java$time$temporal$ChronoUnit[((ChronoUnit) temporalUnit).ordinal()]) {
            ...
            case 4:
                return plusYears(j);
            case 5:
                return plusYears(Duration$$ExternalSyntheticBackport0.m(j, 10L));
            case 6:
                return plusYears(Duration$$ExternalSyntheticBackport0.m(j, 100L));
            case 7:
                return plusYears(Duration$$ExternalSyntheticBackport0.m(j, 1000L));
            case 8:
    ...
    public LocalDate plusDays(long j) {
        return j == 0 ? this : ofEpochDay(Clock$OffsetClock$$ExternalSyntheticBackport0.m(toEpochDay(), j));
    }
    ...
    public LocalDate plusMonths(long j) {
        ...
        return resolvePreviousValid(ChronoField.YEAR.checkValidIntValue(Duration$$ExternalSyntheticBackport1.m(j2, 12L)), ((int) Clock$TickClock$$ExternalSyntheticBackport0.m(j2, 12L)) + 1, this.day);
    }

    public LocalDate plusWeeks(long j) {
        return plusDays(Duration$$ExternalSyntheticBackport0.m(j, 7L));
    }
