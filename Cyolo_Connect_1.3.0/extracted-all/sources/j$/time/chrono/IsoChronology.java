...
public final class IsoChronology extends AbstractChronology implements Serializable {
    ...
    void resolveProlepticMonth(Map map, ResolverStyle resolverStyle) {
        ...
        if (l != null) {
            ...
            addFieldValue(map, ChronoField.MONTH_OF_YEAR, Clock$TickClock$$ExternalSyntheticBackport0.m(l.longValue(), 12L) + 1);
            addFieldValue(map, ChronoField.YEAR, Duration$$ExternalSyntheticBackport1.m(l.longValue(), 12L));
        }
    }
    ...
    public LocalDate resolveYearOfEra(Map map, ResolverStyle resolverStyle) {
        ...
        if (l2 != null) {
            if (l2.longValue() == 1) {
                ...
                chronoField = ChronoField.YEAR;
                jM = Instant$$ExternalSyntheticBackport0.m(1L, l.longValue());
            }
            addFieldValue(map, chronoField, jM);
            return null;
        }
        ...
        if (resolverStyle == ResolverStyle.STRICT) {
            ...
            if (jLongValue2 <= 0) {
                jLongValue = Instant$$ExternalSyntheticBackport0.m(1L, jLongValue);
            }
