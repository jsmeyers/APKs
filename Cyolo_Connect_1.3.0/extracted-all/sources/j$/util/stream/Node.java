...
interface Node {
    ...
    public interface OfDouble extends OfPrimitive {
        ...
        public abstract /* synthetic */ class CC {
            ...
            public static double[] m426$default$newArray(OfDouble ofDouble, int i) {
                return new double[i];
            }
    ...
    public interface OfInt extends OfPrimitive {
        ...
        public abstract /* synthetic */ class CC {
            ...
            /* JADX INFO: renamed from: $default$newArray, reason: collision with other method in class */
            public static int[] m428$default$newArray(OfInt ofInt, int i) {
                return new int[i];
            }
    ...
    public interface OfLong extends OfPrimitive {
        ...
        public abstract /* synthetic */ class CC {
            ...
            /* JADX INFO: renamed from: $default$newArray, reason: collision with other method in class */
            public static long[] m430$default$newArray(OfLong ofLong, int i) {
                return new long[i];
            }
