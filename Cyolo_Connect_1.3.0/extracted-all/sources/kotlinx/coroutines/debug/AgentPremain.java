...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM442constructorimpl = Result.m442constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM442constructorimpl = Result.m442constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m448isFailureimpl(objM442constructorimpl) ? null : objM442constructorimpl);
