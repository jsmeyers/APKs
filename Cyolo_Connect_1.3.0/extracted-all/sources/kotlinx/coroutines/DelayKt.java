...
public final class DelayKt {
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2035scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m1965delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m1966toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1966toDelayMillisLRDsOJo(long j) {
        if (Duration.m1800compareToLRDsOJo(j, Duration.INSTANCE.m1904getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1819getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
