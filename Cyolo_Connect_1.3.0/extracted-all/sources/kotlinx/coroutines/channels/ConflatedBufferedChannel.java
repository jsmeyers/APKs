...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM2007trySendImplMj0NB7M = conflatedBufferedChannel.m2007trySendImplMj0NB7M(e, true);
        if (objM2007trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m1993exceptionOrNullimpl(objM2007trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM2007trySendImplMj0NB7M = conflatedBufferedChannel.m2007trySendImplMj0NB7M(e, true);
        if (!(objM2007trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo1979trySendJP2dKIU(E element) {
        return m2007trySendImplMj0NB7M(element, false);
    }

    /* JADX INFO: renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m2007trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m2005trySendDropLatestMj0NB7M(element, isSendOp) : m2006trySendDropOldestJP2dKIU(element);
    }

    /* JADX INFO: renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m2005trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo1979trySendJP2dKIU = super.mo1979trySendJP2dKIU(element);
        if (ChannelResult.m1999isSuccessimpl(objMo1979trySendJP2dKIU) || ChannelResult.m1997isClosedimpl(objMo1979trySendJP2dKIU)) {
            return objMo1979trySendJP2dKIU;
        }
    ...
    private final Object m2006trySendDropOldestJP2dKIU(E element) {
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo1979trySendJP2dKIU = mo1979trySendJP2dKIU(element);
        if (!(objMo1979trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo1979trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m1993exceptionOrNullimpl(objMo1979trySendJP2dKIU);
