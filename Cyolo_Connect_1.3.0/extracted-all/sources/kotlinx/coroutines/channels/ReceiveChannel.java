...
public interface ReceiveChannel<E> {
    ...
    Object mo1983receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo1984tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1984tryReceivePtdJZtk = receiveChannel.mo1984tryReceivePtdJZtk();
            if (ChannelResult.m1999isSuccessimpl(objMo1984tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1995getOrThrowimpl(objMo1984tryReceivePtdJZtk);
            }
            Throwable thM1993exceptionOrNullimpl = ChannelResult.m1993exceptionOrNullimpl(objMo1984tryReceivePtdJZtk);
            if (thM1993exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1993exceptionOrNullimpl);
        }
        ...
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) throws Throwable {
            ...
            if (i == 0) {
                ...
                objMo1983receiveCatchingJP2dKIU = receiveChannel.mo1983receiveCatchingJP2dKIU(anonymousClass1);
            ...
            return ChannelResult.m1994getOrNullimpl(objMo1983receiveCatchingJP2dKIU);
        }
