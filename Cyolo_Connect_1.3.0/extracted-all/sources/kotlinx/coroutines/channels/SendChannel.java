...
public interface SendChannel<E> {
    ...
    Object mo1979trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m1999isSuccessimpl(objMo1979trySendJP2dKIU)) {
                return true;
            }
            Throwable thM1993exceptionOrNullimpl = ChannelResult.m1993exceptionOrNullimpl(objMo1979trySendJP2dKIU);
