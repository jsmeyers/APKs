...
public class BufferedChannel<E> implements Channel<E> {
    ...
    public Object mo1983receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        return m1981receiveCatchingJP2dKIU$suspendImpl(this, continuation);
    }
    ...
    public final void onClosedSendOnNoWaiterSuspend(E element, CancellableContinuation<? super Unit> cont) {
        ...
        cancellableContinuation.resumeWith(Result.m442constructorimpl(ResultKt.createFailure(sendException)));
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* JADX INFO: renamed from: trySend-JP2dKIU */
    public Object mo1979trySendJP2dKIU(E element) {
        ChannelSegment channelSegment;
        if (shouldSendSuspend(sendersAndCloseStatus$FU.get(this))) {
            return ChannelResult.INSTANCE.m2003failurePtdJZtk();
        }
        ...
        while (true) {
            ...
            return ChannelResult.INSTANCE.m2004successJP2dKIU(Unit.INSTANCE);
        }
        return ChannelResult.INSTANCE.m2002closedJP2dKIU(getSendException());
    }
    ...
    private final boolean tryResumeReceiver(Object obj, E e) {
        ...
        if (obj instanceof ReceiveCatching) {
            ...
            ChannelResult channelResultM1989boximpl = ChannelResult.m1989boximpl(ChannelResult.INSTANCE.m2004successJP2dKIU(e));
            Function1<E, Unit> function1 = this.onUndeliveredElement;
            return BufferedChannelKt.tryResume0(cancellableContinuationImpl, channelResultM1989boximpl, function1 != null ? OnUndeliveredElementKt.bindCancellationFun(function1, e, receiveCatching.cont.getContext()) : null);
        }
    ...
    public final void onClosedReceiveOnNoWaiterSuspend(CancellableContinuation<? super E> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m442constructorimpl(ResultKt.createFailure(getReceiveException())));
    }
    ...
    static /* synthetic */ <E> Object m1981receiveCatchingJP2dKIU$suspendImpl(BufferedChannel<E> bufferedChannel, Continuation<? super ChannelResult<? extends E>> continuation) throws Throwable {
            ...
            if (objUpdateCellReceive != BufferedChannelKt.SUSPEND) {
                if (objUpdateCellReceive != BufferedChannelKt.FAILED) {
                    if (objUpdateCellReceive == BufferedChannelKt.SUSPEND_NO_WAITER) {
                        ...
                        Object objM1982receiveCatchingOnNoWaiterSuspendGKJJFZk = bufferedChannel.m1982receiveCatchingOnNoWaiterSuspendGKJJFZk(channelSegment, i2, andIncrement, bufferedChannel$receiveCatching$12);
                        return objM1982receiveCatchingOnNoWaiterSuspendGKJJFZk == coroutine_suspended ? coroutine_suspended : objM1982receiveCatchingOnNoWaiterSuspendGKJJFZk;
                    }
                    channelSegment.cleanPrev();
                    return ChannelResult.INSTANCE.m2004successJP2dKIU(objUpdateCellReceive);
                }
                if (andIncrement < bufferedChannel.getSendersCounter$kotlinx_coroutines_core()) {
                    channelSegment.cleanPrev();
                }
        ...
        return ChannelResult.INSTANCE.m2002closedJP2dKIU(bufferedChannel.getCloseCause());
    }
    ...
    public final Object m1982receiveCatchingOnNoWaiterSuspendGKJJFZk(ChannelSegment<E> channelSegment, int i, long j, Continuation<? super ChannelResult<? extends E>> continuation) throws Throwable {
        BufferedChannel$receiveCatchingOnNoWaiterSuspend$1 bufferedChannel$receiveCatchingOnNoWaiterSuspend$1;
        ChannelResult channelResultM1989boximpl;
            ...
            try {
                ...
                if (objUpdateCellReceive != BufferedChannelKt.SUSPEND) {
                    ...
                    if (objUpdateCellReceive == BufferedChannelKt.FAILED) {
                        ...
                        while (true) {
                            ...
                            if (objUpdateCellReceive2 != BufferedChannelKt.SUSPEND) {
                                if (objUpdateCellReceive2 == BufferedChannelKt.FAILED) {
                                    ...
                                    channelSegment2.cleanPrev();
                                    channelResultM1989boximpl = ChannelResult.m1989boximpl(ChannelResult.INSTANCE.m2004successJP2dKIU(objUpdateCellReceive2));
                                    Function1<E, Unit> function1 = this.onUndeliveredElement;
                                    if (function1 != null) {
                        ...
                        channelSegment.cleanPrev();
                        channelResultM1989boximpl = ChannelResult.m1989boximpl(ChannelResult.INSTANCE.m2004successJP2dKIU(objUpdateCellReceive));
                        Function1<E, Unit> function12 = this.onUndeliveredElement;
                        if (function12 != null) {
                    ...
                    orCreateCancellableContinuation.resume(channelResultM1989boximpl, function1BindCancellationFun);
                    break;
                }
    ...
    public final void onClosedReceiveCatchingOnNoWaiterSuspend(CancellableContinuation<? super ChannelResult<? extends E>> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m442constructorimpl(ChannelResult.m1989boximpl(ChannelResult.INSTANCE.m2002closedJP2dKIU(getCloseCause()))));
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* JADX INFO: renamed from: tryReceive-PtdJZtk, reason: not valid java name */
    public Object mo1984tryReceivePtdJZtk() {
        ChannelSegment channelSegment;
        long j = receivers$FU.get(this);
        long j2 = sendersAndCloseStatus$FU.get(this);
        if (isClosedForReceive0(j2)) {
            return ChannelResult.INSTANCE.m2002closedJP2dKIU(getCloseCause());
        }
    ...
    public final Object processResultSelectReceiveCatching(Object ignoredParam, Object selectResult) {
        return ChannelResult.m1989boximpl(selectResult == BufferedChannelKt.getCHANNEL_CLOSED() ? ChannelResult.INSTANCE.m2002closedJP2dKIU(getCloseCause()) : ChannelResult.INSTANCE.m2004successJP2dKIU(selectResult));
    }
    ...
    private final class BufferedChannelIterator implements ChannelIterator<E>, Waiter {
        ...
        public final void onClosedHasNextNoWaiterSuspend() {
            ...
            if (closeCause == null) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl.resumeWith(Result.m442constructorimpl(false));
                return;
            }
            ...
            cancellableContinuationImpl2.resumeWith(Result.m442constructorimpl(ResultKt.createFailure(closeCause)));
        }
    ...
    private final void removeUnprocessedElements(ChannelSegment<E> lastSegment) {
        ...
        Object objM2025constructorimpl$default = InlineList.m2025constructorimpl$default(null, 1, null);
        loop0: do {
                    ...
                    if (state$kotlinx_coroutines_core != BufferedChannelKt.BUFFERED) {
                        if (state$kotlinx_coroutines_core == BufferedChannelKt.IN_BUFFER || state$kotlinx_coroutines_core == null) {
                            ...
                            if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                ...
                                objM2025constructorimpl$default = InlineList.m2030plusFjFbRPM(objM2025constructorimpl$default, waiter);
        ...
        if (objM2025constructorimpl$default != null) {
            if (!(objM2025constructorimpl$default instanceof ArrayList)) {
                resumeSenderOnCancelledChannel((Waiter) objM2025constructorimpl$default);
            } else {
                Intrinsics.checkNotNull(objM2025constructorimpl$default, "null cannot be cast to non-null type java.util.ArrayList<E of kotlinx.coroutines.internal.InlineList>{ kotlin.collections.TypeAliasesKt.ArrayList<E of kotlinx.coroutines.internal.InlineList> }");
                ArrayList arrayList = (ArrayList) objM2025constructorimpl$default;
    ...
    private final void cancelSuspendedReceiveRequests(ChannelSegment<E> lastSegment, long sendersCounter) {
            ...
            for (int i = BufferedChannelKt.SEGMENT_SIZE - 1; -1 < i; i--) {
                ...
                while (true) {
                    ...
                    if (state$kotlinx_coroutines_core == null || state$kotlinx_coroutines_core == BufferedChannelKt.IN_BUFFER) {
                        ...
                        if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                            objM2025constructorimpl$default = InlineList.m2030plusFjFbRPM(objM2025constructorimpl$default, ((WaiterEB) state$kotlinx_coroutines_core).waiter);
                        ...
                        if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                            objM2025constructorimpl$default = InlineList.m2030plusFjFbRPM(objM2025constructorimpl$default, state$kotlinx_coroutines_core);
                            lastSegment.onCancelledRequest(i, true);
                            break;
                        }
                    }
        ...
        if (objM2025constructorimpl$default != null) {
            if (!(objM2025constructorimpl$default instanceof ArrayList)) {
                resumeReceiverOnClosedChannel((Waiter) objM2025constructorimpl$default);
                return;
            }
            Intrinsics.checkNotNull(objM2025constructorimpl$default, "null cannot be cast to non-null type java.util.ArrayList<E of kotlinx.coroutines.internal.InlineList>{ kotlin.collections.TypeAliasesKt.ArrayList<E of kotlinx.coroutines.internal.InlineList> }");
            ArrayList arrayList = (ArrayList) objM2025constructorimpl$default;
    ...
    private final void resumeWaiterOnClosedChannel(Waiter waiter, boolean z) {
        if (waiter instanceof SendBroadcast) {
            ...
            Result.Companion companion = Result.INSTANCE;
            cont.resumeWith(Result.m442constructorimpl(false));
            return;
        }
        if (waiter instanceof CancellableContinuation) {
            Continuation continuation = (Continuation) waiter;
            Result.Companion companion2 = Result.INSTANCE;
            continuation.resumeWith(Result.m442constructorimpl(ResultKt.createFailure(z ? getReceiveException() : getSendException())));
            ...
            cancellableContinuationImpl.resumeWith(Result.m442constructorimpl(ChannelResult.m1989boximpl(ChannelResult.INSTANCE.m2002closedJP2dKIU(getCloseCause()))));
    ...
    public final ChannelSegment<E> findSegmentSend(long id, ChannelSegment<E> startFrom) {
        ...
        do {
            ...
            if (!SegmentOrClosed.m2042isClosedimpl(objFindSegmentInternal)) {
                Segment segmentM2040getSegmentimpl = SegmentOrClosed.m2040getSegmentimpl(objFindSegmentInternal);
                while (true) {
                    Segment segment = (Segment) atomicReferenceFieldUpdater.get(this);
                    if (segment.id < segmentM2040getSegmentimpl.id) {
                        if (!segmentM2040getSegmentimpl.tryIncPointers$kotlinx_coroutines_core()) {
                            z = false;
                            break;
                        }
                        if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, segment, segmentM2040getSegmentimpl)) {
                            if (segment.decPointers$kotlinx_coroutines_core()) {
                                segment.remove();
                            }
                        } else if (segmentM2040getSegmentimpl.decPointers$kotlinx_coroutines_core()) {
                            segmentM2040getSegmentimpl.remove();
                        }
                    }
                    z = true;
                    break;
        ...
        ChannelSegment<E> channelSegment = (ChannelSegment) SegmentOrClosed.m2040getSegmentimpl(objFindSegmentInternal);
    ...
    /* JADX WARN: Found duplicated region for block: B:50:0x00ff  */
    /* JADX WARN: Multi-variable type inference failed */
    public final void checkSegmentStructureInvariants() {
        ...
        while (channelSegment.getNext() != 0) {
            ...
            if (((ChannelSegment) next3).getPrev() != 0) {
                ...
                z = ((ChannelSegment) next4).getPrev() == channelSegment;
            }
            if (!z) {
    ...
    public final Object onClosedSend(E e, Continuation<? super Unit> continuation) {
        ...
        if (function1 != null && (undeliveredElementExceptionCallUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            cancellableContinuationImpl3.resumeWith(Result.m442constructorimpl(ResultKt.createFailure(undeliveredElementExceptionRecoverFromStackFrame)));
        } else {
            ...
            cancellableContinuationImpl4.resumeWith(Result.m442constructorimpl(ResultKt.createFailure(sendException)));
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Found duplicated region for block: B:63:0x0142  */
    /* JADX WARN: Found duplicated region for block: B:66:0x014b A[RETURN] */
    /* JADX WARN: Found duplicated region for block: B:67:0x014c  */
    public final Object sendOnNoWaiterSuspend(ChannelSegment<E> channelSegment, int i, E e, long j, Continuation<? super Unit> continuation) {
        ...
        try {
            ...
            cancellableContinuationImpl.resumeWith(objM442constructorimpl);
            result = orCreateCancellableContinuation.getResult();
            if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                DebugProbesKt.probeCoroutineSuspended(continuation);
            }
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (channelSegmentFindSegmentSend != null) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    cancellableContinuationImpl2.resumeWith(Result.m442constructorimpl(Boxing.boxBoolean(false)));
                    break;
                }
            } else {
                channelSegment = channelSegment2;
            ...
            Result.Companion companion3 = Result.INSTANCE;
            cancellableContinuationImpl2.resumeWith(Result.m442constructorimpl(Boxing.boxBoolean(true)));
            break;
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
