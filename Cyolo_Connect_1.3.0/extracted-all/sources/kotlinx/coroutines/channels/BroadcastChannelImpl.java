...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements BroadcastChannel<E> {
        ...
        try {
            ...
            if (!isClosedForSend() || this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                if (this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                    subscriberConflated.mo1979trySendJP2dKIU(getValue());
                }
    ...
    /* JADX WARN: Found duplicated region for block: B:24:0x0068  */
    /* JADX WARN: Found duplicated region for block: B:26:0x007c A[RETURN] */
    /* JADX WARN: Found duplicated region for block: B:27:0x007d A[MOVE_INLINED] */
    /* JADX WARN: Found duplicated region for block: B:30:0x0088  */
    ...
    public Object mo1979trySendJP2dKIU(E element) {
        ...
        try {
            ...
            if (z) {
                Object objM2003failurePtdJZtk = ChannelResult.INSTANCE.m2003failurePtdJZtk();
                reentrantLock.unlock();
                return objM2003failurePtdJZtk;
            }
            if (this.capacity == -1) {
            ...
            while (it2.hasNext()) {
                ((BufferedChannel) it2.next()).mo1979trySendJP2dKIU(element);
            }
            Object objM2004successJP2dKIU = ChannelResult.INSTANCE.m2004successJP2dKIU(Unit.INSTANCE);
            reentrantLock.unlock();
            return objM2004successJP2dKIU;
        } catch (Throwable th) {
            reentrantLock.unlock();
            throw th;
        }
