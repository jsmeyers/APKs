...
public class SelectImplementation<R> extends CancelHandler implements SelectBuilder<R>, SelectInstanceInternal<R> {
    ...
    static final class C01821 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01821(SelectImplementation<R> selectImplementation, Continuation<? super C01821> continuation) {
            super(continuation);
            this.this$0 = selectImplementation;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Found duplicated region for block: B:40:0x0014  */
    ...
    public final Object processResultAndInvokeBlockRecoveringException(SelectImplementation<R>.ClauseData clauseData, Object obj, Continuation<? super R> continuation) throws Throwable {
        ...
        if (continuation instanceof C01821) {
            ...
            if ((c01821.label & Integer.MIN_VALUE) != 0) {
                ...
                c01821 = new C01821(this, continuation);
            }
        } else {
            c01821 = new C01821(this, continuation);
        }
        Object objInvokeBlock = c01821.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c01821.label;
        try {
            if (i == 0) {
                ...
                c01821.label = 1;
                objInvokeBlock = clauseData.invokeBlock(objProcessResult, c01821);
            ...
            if (DebugKt.getRECOVER_STACK_TRACES() && (c01821 instanceof CoroutineStackFrame)) {
                throw StackTraceRecoveryKt.recoverFromStackFrame(th, c01821);
            }
            throw th;
        }
    }
    ...
    public final class ClauseData {
        ...
        public final boolean tryRegisterAsWaiter(SelectImplementation<R> select) {
            ...
            if (DebugKt.getASSERTIONS_ENABLED()) {
                if (!(((SelectImplementation) select).internalResult == SelectKt.NO_RESULT)) {
                    throw new AssertionError();
                }
            }
