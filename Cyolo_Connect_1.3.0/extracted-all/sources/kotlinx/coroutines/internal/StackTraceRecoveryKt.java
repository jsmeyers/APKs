...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM442constructorimpl = Result.m442constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
        ...
        if (Result.m445exceptionOrNullimpl(objM442constructorimpl) == null) {
            obj2 = objM442constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM442constructorimpl2 = Result.m442constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM442constructorimpl2 = Result.m442constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m445exceptionOrNullimpl(objM442constructorimpl2) == null) {
            obj = objM442constructorimpl2;
        }
    ...
    /* JADX WARN: Found duplicated region for block: B:15:0x0032  */
