    ...
    private final LockFreeLinkedListNode correctPrev(OpDescriptor op) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (!AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, lockFreeLinkedListNode3, lockFreeLinkedListNode2, ((Removed) obj).ref)) {
                    break;
                }
