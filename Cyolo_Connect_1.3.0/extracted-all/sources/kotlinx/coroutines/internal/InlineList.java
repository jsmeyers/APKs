...
public final class InlineList<E> {
    ...
    public static final /* synthetic */ InlineList m2023boximpl(Object obj) {
        return new InlineList(obj);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static <E> Object m2024constructorimpl(Object obj) {
        return obj;
    }
    ...
    public static String m2031toStringimpl(Object obj) {
        return "InlineList(holder=" + obj + ')';
    }

    public boolean equals(Object obj) {
        return m2026equalsimpl(this.holder, obj);
    }
    ...
    public String toString() {
        return m2031toStringimpl(this.holder);
    }
    ...
    public static /* synthetic */ Object m2025constructorimpl$default(Object obj, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            obj = null;
        }
        return m2024constructorimpl(obj);
    }

    /* JADX INFO: renamed from: plus-FjFbRPM, reason: not valid java name */
    public static final Object m2030plusFjFbRPM(Object obj, E e) {
        if (DebugKt.getASSERTIONS_ENABLED() && !(!(e instanceof List))) {
            throw new AssertionError();
        }
        if (obj == null) {
            return m2024constructorimpl(e);
        }
        ...
        arrayList.add(obj);
        arrayList.add(e);
        return m2024constructorimpl(arrayList);
    }

    /* JADX INFO: renamed from: forEachReversed-impl, reason: not valid java name */
    public static final void m2028forEachReversedimpl(Object obj, Function1<? super E, Unit> function1) {
        if (obj == null) {
            return;
        }
        if (!(obj instanceof ArrayList)) {
