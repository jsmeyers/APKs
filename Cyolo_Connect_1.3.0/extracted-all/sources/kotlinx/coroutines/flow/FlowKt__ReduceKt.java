...
final /* synthetic */ class FlowKt__ReduceKt {
    ...
    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ReduceKt", f = "Reduce.kt", i = {0, 0}, l = {183}, m = "firstOrNull", n = {"result", "collector$iv"}, s = {"L$0", "L$1"})
    static final class C01693<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        C01693(Continuation<? super C01693> continuation) {
            super(continuation);
        }
    ...
    static final class C01701<T, R> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    static final class C01751<S, T extends S> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    static final class C01771<T> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;
    ...
    static final class C01791<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;
    ...
    public static final <S, T extends S> Object reduce(Flow<? extends T> flow, Function3<? super S, ? super T, ? super Continuation<? super S>, ? extends Object> function3, Continuation<? super S> continuation) throws Throwable {
        ...
        if (continuation instanceof C01751) {
            c01751 = (C01751) continuation;
            if ((c01751.label & Integer.MIN_VALUE) != 0) {
                c01751.label -= Integer.MIN_VALUE;
            } else {
                c01751 = new C01751(continuation);
            }
        } else {
            c01751 = new C01751(continuation);
        }
        ...
        if (i == 0) {
            ...
            FlowCollector<? super Object> c01762 = new C01762<>(objectRef2, function3);
            c01751.L$0 = objectRef2;
            c01751.label = 1;
            if (flow.collect(c01762, c01751) == coroutine_suspended) {
            ...
            objectRef = (Ref.ObjectRef) c01751.L$0;
            ResultKt.throwOnFailure(obj);
        }
    ...
    /* JADX INFO: compiled from: Reduce.kt */
    @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0005\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\b\b\u0001\u0010\u0003*\u0002H\u00022\u0006\u0010\u0004\u001a\u0002H\u0003H\u008a@¢\u0006\u0004\b\u0005\u0010\u0006"}, d2 = {"<anonymous>", "", "S", "T", MainActivityKt.INTENT_SERVICE_STATUS_EXTRA_VALUE, "emit", "(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;"}, k = 3, mv = {1, 8, 0}, xi = 48)
    static final class C01762<T> implements FlowCollector {
        final /* synthetic */ Ref.ObjectRef<Object> $accumulator;
        final /* synthetic */ Function3<S, T, Continuation<? super S>, Object> $operation;

        /* JADX WARN: Multi-variable type inference failed */
        C01762(Ref.ObjectRef<Object> objectRef, Function3<? super S, ? super T, ? super Continuation<? super S>, ? extends Object> function3) {
    ...
    public static final <T, R> Object fold(Flow<? extends T> flow, R r, Function3<? super R, ? super T, ? super Continuation<? super R>, ? extends Object> function3, Continuation<? super R> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            c01701.label = 1;
            if (flow.collect(anonymousClass2, c01701) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
    ...
    public static final <T> Object single(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            c01771.L$0 = objectRef2;
            c01771.label = 1;
            if (flow.collect(flowCollector, c01771) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
            ...
            objectRef = (Ref.ObjectRef) c01771.L$0;
            ResultKt.throwOnFailure(obj);
        }
        if (objectRef.element == NullSurrogateKt.NULL) {
    ...
    public static final <T> Object singleOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            try {
                c01791.L$0 = objectRef2;
                c01791.L$1 = flowCollector2;
                c01791.label = 1;
                if (flow.collect(flowCollector2, c01791) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            ...
            flowCollector = (FlowKt__ReduceKt$singleOrNull$$inlined$collectWhile$1) c01791.L$1;
            objectRef = (Ref.ObjectRef) c01791.L$0;
            try {
                ResultKt.throwOnFailure(obj);
    ...
    public static final <T> Object firstOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            try {
                ...
                c01681.L$1 = flowCollector2;
                c01681.label = 1;
                if (flow.collect(flowCollector2, c01681) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            } catch (AbortFlowException e2) {
            ...
            flowCollector = (FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$1) c01681.L$1;
    ...
    public static final <T> Object firstOrNull(Flow<? extends T> flow, Function2<? super T, ? super Continuation<? super Boolean>, ? extends Object> function2, Continuation<? super T> continuation) throws Throwable {
        ...
        AbortFlowException e;
        FlowCollector<? super Object> flowCollector;
        if (continuation instanceof C01693) {
            c01693 = (C01693) continuation;
            if ((c01693.label & Integer.MIN_VALUE) != 0) {
                c01693.label -= Integer.MIN_VALUE;
            } else {
                c01693 = new C01693(continuation);
            }
        } else {
            c01693 = new C01693(continuation);
        }
        Object obj = c01693.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c01693.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            try {
                c01693.L$0 = objectRef2;
                c01693.L$1 = flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2;
                c01693.label = 1;
                if (flow.collect(flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2, c01693) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                objectRef = objectRef2;
            } catch (AbortFlowException e2) {
            ...
            flowCollector = (FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2) c01693.L$1;
            objectRef = (Ref.ObjectRef) c01693.L$0;
            try {
                ResultKt.throwOnFailure(obj);
            } catch (AbortFlowException e3) {
                e = e3;
    ...
    public static final <T> Object lastOrNull(Flow<? extends T> flow, Continuation<? super T> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            c01731.label = 1;
            if (flow.collect(flowCollector, c01731) == coroutine_suspended) {
                return coroutine_suspended;
            }
            objectRef = objectRef2;
        } else {
