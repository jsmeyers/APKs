...
public final /* synthetic */ class BuildersKt__BuildersKt {
    ...
    /* JADX WARN: Found duplicated region for block: B:16:0x003d  */
    public static final <T> T runBlocking(CoroutineContext coroutineContext, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2) throws InterruptedException {
        ...
        if (continuationInterceptor == null) {
            ...
            if (eventLoop != null) {
                ...
                eventLoopCurrentOrNull$kotlinx_coroutines_core = eventLoop2 == null ? ThreadLocalEventLoop.INSTANCE.currentOrNull$kotlinx_coroutines_core() : eventLoop2;
            }
