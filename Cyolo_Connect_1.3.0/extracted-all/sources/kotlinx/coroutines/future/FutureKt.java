...
public final class FutureKt {
    ...
    public static final <T> CompletableFuture<T> future(CoroutineScope coroutineScope, CoroutineContext coroutineContext, CoroutineStart coroutineStart, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2) {
        ...
        CompletableFutureCoroutine completableFutureCoroutine = new CompletableFutureCoroutine(coroutineContextNewCoroutineContext, completableFutureM2226m);
        completableFutureM2226m.handle(BiFunction.Wrapper.convert(completableFutureCoroutine));
    ...
    public static final <T> CompletableFuture<T> asCompletableFuture(final Deferred<? extends T> deferred) {
        final CompletableFuture<T> completableFutureM2226m = NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m2226m();
        setupCancellation(deferred, completableFutureM2226m);
        deferred.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.future.FutureKt.asCompletableFuture.1
            ...
            public final void invoke2(Throwable th) {
                try {
                    completableFutureM2226m.complete(deferred.getCompleted());
                } catch (Throwable th2) {
                    completableFutureM2226m.completeExceptionally(th2);
                }
            }
        });
        return completableFutureM2226m;
    ...
    public static final CompletableFuture<Unit> asCompletableFuture(Job job) {
        final CompletableFuture<Unit> completableFutureM2226m = NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m2226m();
        setupCancellation(job, completableFutureM2226m);
        job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.future.FutureKt.asCompletableFuture.2
            ...
            public final void invoke2(Throwable th) {
                if (th == null) {
                    completableFutureM2226m.complete(Unit.INSTANCE);
                } else {
    ...
    private static final void setupCancellation(final Job job, CompletableFuture<?> completableFuture) {
        completableFuture.handle((java.util.function.BiFunction<? super Object, Throwable, ? extends U>) BiFunction.Wrapper.convert(new BiFunction() { // from class: kotlinx.coroutines.future.FutureKt$$ExternalSyntheticLambda7
    ...
    public static final <T> Deferred<T> asDeferred(CompletionStage<T> completionStage) {
            ...
            public final Object invoke(T t, Throwable th2) {
                ...
                try {
                    if (th2 == null) {
                        ...
                        CompletionException completionExceptionM2228m = NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m$1(th2) ? NioSystemFileSystem$$ExternalSyntheticApiModelOutline0.m2228m((Object) th2) : null;
                        if (completionExceptionM2228m != null && (cause2 = completionExceptionM2228m.getCause()) != null) {
                            th2 = cause2;
                        }
        ...
        completionStage.handle(BiFunction.Wrapper.convert(new BiFunction() { // from class: kotlinx.coroutines.future.FutureKt$$ExternalSyntheticLambda6
            @Override // j$.util.function.BiFunction
            public /* synthetic */ BiFunction andThen(Function function) {
                return BiFunction.CC.$default$andThen(this, function);
            }
    ...
    public static final <T> Object await(CompletionStage<T> completionStage, Continuation<? super T> continuation) throws Throwable {
        ...
        completionStage.handle(BiFunction.Wrapper.convert(continuationHandler));
