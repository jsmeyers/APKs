...
public final class TimeoutKt {
    ...
    public static final <T> Object m1975withTimeoutKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m1966toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    public static final <T> Object m1976withTimeoutOrNullKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m1966toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    public static final TimeoutCancellationException TimeoutCancellationException(long j, Delay delay, Job job) {
        ...
        if (delayWithTimeoutDiagnostics != null) {
            ...
            strM1967timeoutMessageLRDsOJo = delayWithTimeoutDiagnostics.m1967timeoutMessageLRDsOJo(DurationKt.toDuration(j, DurationUnit.MILLISECONDS));
            if (strM1967timeoutMessageLRDsOJo == null) {
                strM1967timeoutMessageLRDsOJo = "Timed out waiting for " + j + " ms";
            }
        } else {
            strM1967timeoutMessageLRDsOJo = "Timed out waiting for " + j + " ms";
        }
        return new TimeoutCancellationException(strM1967timeoutMessageLRDsOJo, job);
    }
}
