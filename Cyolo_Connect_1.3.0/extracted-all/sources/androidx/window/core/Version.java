...
public final class Version implements Comparable<Version> {
    ...
    public String toString() {
        return this.major + FilenameUtils.EXTENSION_SEPARATOR + this.minor + FilenameUtils.EXTENSION_SEPARATOR + this.patch + (StringsKt.isBlank(this.description) ^ true ? Intrinsics.stringPlus("-", this.description) : "");
    }
