    ...
    public final void markPostponedState() {
        ...
        synchronized (this.pendingOperations) {
            ...
            do {
                ...
                operation = operationPrevious;
                companion = Operation.State.INSTANCE;
                view = operation.getFragment().mView;
                Intrinsics.checkNotNullExpressionValue(view, "operation.fragment.mView");
            } while (!(operation.getFinalState() == Operation.State.VISIBLE && companion.asOperationState(view) != Operation.State.VISIBLE));
