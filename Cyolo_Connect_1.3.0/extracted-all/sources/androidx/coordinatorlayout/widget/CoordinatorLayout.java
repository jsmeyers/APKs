...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    /* JADX WARN: Found duplicated region for block: B:11:0x002b A[PHI: r3
      0x002b: PHI (r3v4 boolean) = (r3v2 boolean), (r3v5 boolean) binds: [B:9:0x0022, B:5:0x0012] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Found duplicated region for block: B:14:0x0031  */
    /* JADX WARN: Found duplicated region for block: B:15:0x0037 A[DONT_INVERT] */
    /* JADX WARN: Found duplicated region for block: B:16:0x0039 A[MOVE_INLINED] */
    /* JADX WARN: Found duplicated region for block: B:18:0x004c  */
    /* JADX WARN: Found duplicated region for block: B:22:0x0054  */
    @Override // android.view.View
    ...
    /* JADX WARN: Found duplicated region for block: B:39:0x00f3  */
    /* JADX WARN: Found duplicated region for block: B:42:0x00fd A[MOVE_INLINED] */
    /* JADX WARN: Found duplicated region for block: B:45:0x011f  */
    @Override // android.view.View
    protected void onMeasure(int i, int i2) {
        ...
        while (i14 < size3) {
            ...
            if (view.getVisibility() == 8) {
                ...
                onMeasureChild(view, iMakeMeasureSpec, iMax, iMakeMeasureSpec2, 0);
                LayoutParams layoutParams3222 = layoutParams;
                int iMax2222 = Math.max(i9, i10 + view.getMeasuredWidth() + layoutParams3222.leftMargin + layoutParams3222.rightMargin);
                int iMax3222 = Math.max(i4, i11 + view.getMeasuredHeight() + layoutParams3222.topMargin + layoutParams3222.bottomMargin);
                iCombineMeasuredStates = View.combineMeasuredStates(i7, view.getMeasuredState());
                i12 = iMax2222;
                i13 = iMax3222;
            }
    ...
    /* JADX WARN: Found duplicated region for block: B:46:0x00ca  */
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            if (i != 0 || view.getVisibility() != 8) {
                ...
                if (i != 2) {
                    ...
                    while (i2 < size) {
                        View view22 = this.mDependencySortedChildren.get(i2);
                        LayoutParams layoutParams22 = (LayoutParams) view22.getLayoutParams();
                        behavior = layoutParams22.getBehavior();
                        if (behavior == null) {
                        }
                    }
                }
