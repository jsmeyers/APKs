...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    addPerson(Person.fromAndroidPerson(ColorKt$$ExternalSyntheticApiModelOutline0.m30m(it2.next())));
                }
            }
    ...
    public static abstract class Style {
        ...
        private static Style constructCompatStyleByPlatformName(String str) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                if (str.equals(ColorKt$$ExternalSyntheticApiModelOutline0.m44m().getName())) {
        ...
        /* JADX WARN: Found duplicated region for block: B:34:0x0118  */
        /* JADX WARN: Found duplicated region for block: B:36:0x0127  */
        /* JADX WARN: Found duplicated region for block: B:37:0x0137  */
        /* JADX WARN: Found duplicated region for block: B:38:0x013c  */
        /* JADX WARN: Found duplicated region for block: B:40:0x013f A[DONT_INVERT] */
        /* JADX WARN: Found duplicated region for block: B:41:0x0141  */
        /* JADX WARN: Found duplicated region for block: B:45:0x0163  */
        /* JADX WARN: Found duplicated region for block: B:47:0x0169  */
        /* JADX WARN: Found duplicated region for block: B:52:0x01a2  */
        /* JADX WARN: Found duplicated region for block: B:53:0x01b5  */
        /* JADX WARN: Found duplicated region for block: B:56:0x01ba  */
        /* JADX WARN: Found duplicated region for block: B:57:0x01bc  */
        /* JADX WARN: Found duplicated region for block: B:61:0x01c6  */
    ...
    public static class BigPictureStyle extends Style {
        ...
        private static IconCompat asIconCompat(Parcelable parcelable) {
            ...
            if (Build.VERSION.SDK_INT >= 23 && ColorKt$$ExternalSyntheticApiModelOutline0.m55m((Object) parcelable)) {
                return IconCompat.createFromIcon(ColorKt$$ExternalSyntheticApiModelOutline0.m40m((Object) parcelable));
            }
                ...
                try {
                    if (bundle.containsKey(KEY_TEXT) && bundle.containsKey(KEY_TIMESTAMP)) {
                        if (bundle.containsKey(KEY_PERSON)) {
                            ...
                            personBuild = Person.fromAndroidPerson(ColorKt$$ExternalSyntheticApiModelOutline0.m30m((Object) bundle.getParcelable(KEY_NOTIFICATION_PERSON)));
                        } else {
    ...
    public static class CallStyle extends Style {
        ...
        protected void restoreFromCompatExtras(Bundle bundle) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && bundle.containsKey(NotificationCompat.EXTRA_CALL_PERSON)) {
                this.mPerson = Person.fromAndroidPerson(ColorKt$$ExternalSyntheticApiModelOutline0.m30m((Object) bundle.getParcelable(NotificationCompat.EXTRA_CALL_PERSON)));
            ...
            if (Build.VERSION.SDK_INT >= 23 && bundle.containsKey(NotificationCompat.EXTRA_VERIFICATION_ICON)) {
                this.mVerificationIcon = IconCompat.createFromIcon(ColorKt$$ExternalSyntheticApiModelOutline0.m40m((Object) bundle.getParcelable(NotificationCompat.EXTRA_VERIFICATION_ICON)));
        ...
        private static Notification.Action getActionFromActionCompat(Action action) {
            Notification.Action.Builder builderCreateActionBuilder;
            Bundle bundle;
            if (Build.VERSION.SDK_INT >= 23) {
                IconCompat iconCompat = action.getIconCompat();
                builderCreateActionBuilder = Api23Impl.createActionBuilder(iconCompat == null ? null : iconCompat.toIcon(), action.getTitle(), action.getActionIntent());
            } else {
                IconCompat iconCompat2 = action.getIconCompat();
                builderCreateActionBuilder = Api20Impl.createActionBuilder((iconCompat2 == null || iconCompat2.getType() != 2) ? 0 : iconCompat2.getResId(), action.getTitle(), action.getActionIntent());
            }
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* JADX INFO: renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m23clone() {
            WearableExtender wearableExtender = new WearableExtender();
    ...
    public static List<Person> getPeople(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(Person.fromAndroidPerson(ColorKt$$ExternalSyntheticApiModelOutline0.m30m(it.next())));
                }
            }
        } else {
