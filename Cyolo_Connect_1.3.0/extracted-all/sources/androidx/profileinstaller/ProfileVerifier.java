...
public final class ProfileVerifier {
    ...
    /* JADX WARN: Found duplicated region for block: B:23:0x0046  */
    /* JADX WARN: Found duplicated region for block: B:29:0x0069  */
    /* JADX WARN: Found duplicated region for block: B:39:0x008c  */
    /* JADX WARN: Found duplicated region for block: B:48:0x009e A[DONT_INVERT] */
    /* JADX WARN: Found duplicated region for block: B:49:0x00a0  */
    /* JADX WARN: Found duplicated region for block: B:50:0x00a2 A[DONT_INVERT] */
    /* JADX WARN: Found duplicated region for block: B:51:0x00a4  */
    /* JADX WARN: Found duplicated region for block: B:84:0x007f A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /* JADX WARN: Found duplicated region for block: B:87:0x00cb A[EXC_TOP_SPLITTER, SYNTHETIC] */
    static CompilationStatus writeProfileVerification(Context context, boolean z) {
        ...
        synchronized (SYNC_OBJ) {
            ...
            if (Build.VERSION.SDK_INT >= 28) {
                ...
                file = new File(context.getFilesDir(), PROFILE_INSTALLED_CACHE_FILE_NAME);
                fromFile = file.exists() ? Cache.readFromFile(file) : null;
                if (fromFile == null) {
                    if (z2) {
                        i = 1;
                    } else if (z3) {
