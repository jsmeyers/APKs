...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    /* JADX WARN: Found duplicated region for block: B:15:0x0045  */
    @Override // androidx.appcompat.app.AppCompatDelegate
    ...
    private boolean onKeyUpPanel(int i, KeyEvent keyEvent) {
        ...
        boolean zShowOverflowMenu = true;
        PanelFeatureState panelState = getPanelState(i, true);
        if (i == 0 && (decorContentParent = this.mDecorContentParent) != null && decorContentParent.canShowOverflowMenu() && !ViewConfiguration.get(this.mContext).hasPermanentMenuKey()) {
            if (!this.mDecorContentParent.isOverflowMenuShowing()) {
                zShowOverflowMenu = (this.mDestroyed || !preparePanel(panelState, keyEvent)) ? false : this.mDecorContentParent.showOverflowMenu();
            } else {
                zShowOverflowMenu = this.mDecorContentParent.hideOverflowMenu();
            }
    ...
    /* JADX WARN: Found duplicated region for block: B:20:0x004b  */
    ...
    private static Configuration generateConfigDelta(Configuration configuration, Configuration configuration2) {
        ...
        if (configuration2 != null && configuration.diff(configuration2) != 0) {
            ...
            if ((configuration.screenLayout & Wbxml.EXT_0) != (configuration2.screenLayout & Wbxml.EXT_0)) {
                configuration3.screenLayout |= configuration2.screenLayout & Wbxml.EXT_0;
            }
