...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    /* JADX WARN: Found duplicated region for block: B:16:0x0051 A[PHI: r10 r11
    ...
    private static class DropDownAdapter implements ListAdapter, SpinnerAdapter {
        ...
        public DropDownAdapter(SpinnerAdapter spinnerAdapter, Resources.Theme theme) {
            ...
            if (theme != null) {
                if (Build.VERSION.SDK_INT >= 23 && ComponentDialog$$ExternalSyntheticApiModelOutline0.m15m((Object) spinnerAdapter)) {
                    android.widget.ThemedSpinnerAdapter themedSpinnerAdapterM12m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m12m((Object) spinnerAdapter);
                    if (themedSpinnerAdapterM12m.getDropDownViewTheme() != theme) {
                        themedSpinnerAdapterM12m.setDropDownViewTheme(theme);
                        return;
                    }
                    return;
                }
