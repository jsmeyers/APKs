...
public class SlidingPaneLayout extends ViewGroup {
    ...
    /* JADX WARN: Found duplicated region for block: B:130:0x0122 A[SYNTHETIC] */
    /* JADX WARN: Found duplicated region for block: B:39:0x00b3 A[PHI: r13
      0x00b3: PHI (r13v2 float) = (r13v1 float), (r13v3 float) binds: [B:35:0x00a8, B:37:0x00af] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Found duplicated region for block: B:41:0x00bd  */
    /* JADX WARN: Found duplicated region for block: B:42:0x00c8  */
    /* JADX WARN: Found duplicated region for block: B:44:0x00cd  */
    /* JADX WARN: Found duplicated region for block: B:45:0x00d6  */
    /* JADX WARN: Found duplicated region for block: B:48:0x00e3  */
    /* JADX WARN: Found duplicated region for block: B:49:0x00ea  */
    /* JADX WARN: Found duplicated region for block: B:51:0x00ef  */
    /* JADX WARN: Found duplicated region for block: B:52:0x00f6  */
    /* JADX WARN: Found duplicated region for block: B:59:0x0116  */
    /* JADX WARN: Found duplicated region for block: B:60:0x0118  */
    /* JADX WARN: Found duplicated region for block: B:63:0x0120  */
    /* JADX WARN: Found duplicated region for block: B:72:0x0143  */
                            ...
                            if (layoutParams2.weight > 0.0f) {
                                if (layoutParams2.width == 0) {
                                    if (layoutParams2.height == -2) {
                                        ...
                                        iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(paddingTop, Ints.MAX_POWER_OF_TWO);
                                    } else {
                                        iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(layoutParams2.height, Ints.MAX_POWER_OF_TWO);
                                    }
                                } else {
    ...
    /* JADX WARN: Found duplicated region for block: B:9:0x001c  */
    private void parallaxOtherViews(float f) {
        boolean z;
        boolean zIsLayoutRtlSupport = isLayoutRtlSupport();
        LayoutParams layoutParams = (LayoutParams) this.mSlideableView.getLayoutParams();
        if (layoutParams.dimWhenOffset) {
            z = (zIsLayoutRtlSupport ? layoutParams.rightMargin : layoutParams.leftMargin) <= 0;
        }
        int childCount = getChildCount();
        for (int i = 0; i < childCount; i++) {
            View childAt = getChildAt(i);
