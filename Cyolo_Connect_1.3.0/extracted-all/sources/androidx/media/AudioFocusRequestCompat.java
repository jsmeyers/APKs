...
public class AudioFocusRequestCompat {
    ...
    AudioFocusRequestCompat(int i, AudioManager.OnAudioFocusChangeListener onAudioFocusChangeListener, Handler handler, AudioAttributesCompat audioAttributesCompat, boolean z) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            Trace$$ExternalSyntheticApiModelOutline0.m192m();
            this.mFrameworkAudioFocusRequest = Trace$$ExternalSyntheticApiModelOutline0.m(i).setAudioAttributes(getAudioAttributes()).setWillPauseWhenDucked(z).setOnAudioFocusChangeListener(this.mOnAudioFocusChangeListener, handler).build();
        } else {
    ...
    AudioFocusRequest getAudioFocusRequest() {
        return TextViewCompat$$ExternalSyntheticApiModelOutline0.m(this.mFrameworkAudioFocusRequest);
    }
