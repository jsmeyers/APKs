...
public class NonExecutingTestSuite extends DelegatingFilterableTestSuite {
    ...
    @Override // androidx.test.internal.runner.junit3.DelegatingTestSuite, junit.framework.TestSuite
    public /* bridge */ /* synthetic */ void runTest(Test test, TestResult result) {
        super.runTest(test, result);
    }

    @Override // androidx.test.internal.runner.junit3.DelegatingTestSuite
    public /* bridge */ /* synthetic */ void setDelegateSuite(TestSuite newSuiteDelegate) {
        super.setDelegateSuite(newSuiteDelegate);
    }

    @Override // androidx.test.internal.runner.junit3.DelegatingTestSuite, junit.framework.TestSuite
    public /* bridge */ /* synthetic */ void setName(String name) {
        super.setName(name);
    }

    @Override // androidx.test.internal.runner.junit3.DelegatingTestSuite, junit.framework.TestSuite
    public /* bridge */ /* synthetic */ Test testAt(int index) {
