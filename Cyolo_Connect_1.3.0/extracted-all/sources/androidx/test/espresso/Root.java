...
public final class Root {
    ...
    public boolean isReady() {
        ...
        return this.decorView.hasWindowFocus() || (this.windowLayoutParams.get().flags & 8) == 8;
    }
    ...
    public String toString() {
        ...
        if (this.windowLayoutParams.isPresent()) {
            toStringHelperAdd.add("layout-params-type", this.windowLayoutParams.get().type).add("layout-params-string", this.windowLayoutParams.get());
        }
