...
public final class AdapterDataLoaderAction implements ViewAction {
    ...
    public AdapterDataLoaderAction(Matcher<? extends Object> dataToLoadMatcher, EspressoOptional<Integer> atPosition, AdapterViewProtocol adapterViewProtocol) {
        ...
        this.atPosition = (EspressoOptional) Preconditions.checkNotNull(atPosition);
        ...
        synchronized (this.dataLock) {
            ...
            if (this.atPosition.isPresent()) {
                ...
                if (arrayListNewArrayList.size() != 1) {
                    ...
                    StringBuilder sb2 = new StringBuilder(String.valueOf(strValueOf2).length() + 44 + String.valueOf(strValueOf3).length());
