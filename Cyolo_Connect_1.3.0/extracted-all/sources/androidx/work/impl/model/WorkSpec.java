...
public final /* data */ class WorkSpec {
    ...
    public int hashCode() {
        ...
        return ((((((((((((iHashCode + r1) * 31) + this.outOfQuotaPolicy.hashCode()) * 31) + this.periodCount) * 31) + this.generation) * 31) + UByte$$ExternalSyntheticBackport0.m(this.nextScheduleTimeOverride)) * 31) + this.nextScheduleTimeOverrideGeneration) * 31) + this.stopReason;
    }
