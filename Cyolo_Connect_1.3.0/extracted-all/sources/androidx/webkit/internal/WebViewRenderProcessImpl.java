...
public class WebViewRenderProcessImpl extends WebViewRenderProcess {
    ...
    public boolean terminate() {
        ...
        if (q.isSupportedByFramework()) {
            android.webkit.WebViewRenderProcess webViewRenderProcessM245m = RootDetector$$ExternalSyntheticApiModelOutline0.m245m((Object) this.mFrameworkObject.get());
            return webViewRenderProcessM245m != null && ApiHelperForQ.terminate(webViewRenderProcessM245m);
        }
