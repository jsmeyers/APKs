...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        for (int i14 = 0; i14 < i10; i14++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i11) {
                ...
                if (this.mOrientation == 1) {
                    childMeasureSpec2 = getChildMeasureSpec(spaceForSpanRange, Ints.MAX_POWER_OF_TWO, i16, layoutParams.width, false);
                    childMeasureSpec = View.MeasureSpec.makeMeasureSpec(i11 - i15, Ints.MAX_POWER_OF_TWO);
                } else {
                    int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i11 - i16, Ints.MAX_POWER_OF_TWO);
                    childMeasureSpec = getChildMeasureSpec(spaceForSpanRange, Ints.MAX_POWER_OF_TWO, i15, layoutParams.height, false);
    ...
    public static abstract class SpanSizeLookup {
        ...
        /* JADX WARN: Found duplicated region for block: B:14:0x002a  */
        /* JADX WARN: Found duplicated region for block: B:16:0x0031  */
        /* JADX WARN: Found duplicated region for block: B:17:0x0033 A[DONT_INVERT] */
        /* JADX WARN: Found duplicated region for block: B:18:0x0035  */
