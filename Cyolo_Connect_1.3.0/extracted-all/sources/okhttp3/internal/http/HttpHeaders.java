...
public final class HttpHeaders {
    ...
    /* JADX WARN: Found duplicated region for block: B:29:0x0088  */
    /* JADX WARN: Found duplicated region for block: B:37:0x009b  */
    /* JADX WARN: Found duplicated region for block: B:38:0x00a0  */
    /* JADX WARN: Found duplicated region for block: B:59:0x007d A[EDGE_INSN: B:59:0x007d->B:28:0x007d BREAK  A[LOOP:2: B:22:0x006a->B:49:0x00bd], SYNTHETIC] */
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (!zSkipCommasAndWhitespace && (zSkipCommasAndWhitespace2 || buffer.exhausted())) {
                    Map mapSingletonMap = Collections.singletonMap(null, Intrinsics.stringPlus(token2, StringsKt.repeat("=", iSkipAll)));
                    ...
                    while (true) {
                        if (token2 == null) {
                            ...
                            quotedString = startsWith(buffer, JsonWriter.QUOTE) ? readQuotedString(buffer) : readToken(buffer);
                            ...
                            if (startsWith(buffer, JsonWriter.QUOTE)) {
                            }
