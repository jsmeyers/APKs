...
public final class PublicSuffixDatabase {
    ...
    private final List<String> findMatchingRule(List<String> domainLabels) {
        ...
        if (strBinarySearch3 != null) {
            return StringsKt.split$default((CharSequence) Intrinsics.stringPlus("!", strBinarySearch3), new char[]{FilenameUtils.EXTENSION_SEPARATOR}, false, 0, 6, (Object) null);
        }
        if (strBinarySearch == null && strBinarySearch2 == null) {
            return PREVAILING_RULE;
        }
        List<String> listSplit$default = strBinarySearch == null ? null : StringsKt.split$default((CharSequence) strBinarySearch, new char[]{FilenameUtils.EXTENSION_SEPARATOR}, false, 0, 6, (Object) null);
        if (listSplit$default == null) {
            listSplit$default = CollectionsKt.emptyList();
        }
        List<String> listSplit$default2 = strBinarySearch2 != null ? StringsKt.split$default((CharSequence) strBinarySearch2, new char[]{FilenameUtils.EXTENSION_SEPARATOR}, false, 0, 6, (Object) null) : null;
