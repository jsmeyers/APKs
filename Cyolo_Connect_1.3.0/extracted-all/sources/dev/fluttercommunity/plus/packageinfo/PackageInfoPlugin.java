    ...
    public void onMethodCall(MethodCall call, MethodChannel.Result result) {
        ...
        try {
            if (Intrinsics.areEqual(call.method, "getAll")) {
                ...
                map.put(Constants.APP_NAME, packageInfo.applicationInfo.loadLabel(packageManager).toString());
    ...
    private final String getBuildSignature(PackageManager pm) {
        ...
        try {
            if (Build.VERSION.SDK_INT >= 28) {
                ...
                Context context2 = this.applicationContext;
                Intrinsics.checkNotNull(context2);
                PackageInfo packageInfo = pm.getPackageInfo(context2.getPackageName(), 64);
                ...
                strSignatureToSha1 = signatureToSha1(byteArray3);
            }
